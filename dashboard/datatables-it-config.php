                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $slaDate = new DateTime($row['sla_itconfig']);
                                                ...
                                                <?php if ($row['status_itconfig'] != "Done"): ?>
                                                        ...
                                                        <button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="<?= $row['id'] ?>" data-status="<?= $row['status_itconfig'] ?>">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="it/it-config-process.php" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status IT</label>
