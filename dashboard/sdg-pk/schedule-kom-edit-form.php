		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Data Schedule Kick Off Meeting</h1>
                    <ul>
                        <li><a href="href">Edit</a></li>
                        <li>Data Schedule Kick Off Meeting</li>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-5">
                            <div class="card-body">
                            <form method="post" action="schedule-kom-edit.php" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                            
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label" for="start_kickoff">Start Jadwal Kick Off Meeting</label>
                                <div class="col-sm-9">
                                    <input class="form-control" id="start_kickoff" name="start_slakom" type="date" placeholder="Start Jadwal Kick Off Meeting"
                                        min="<?php echo date('Y-m-d'); ?>"
                                        max="<?php echo date('Y-m-d', strtotime('+6 days')); ?>"
                                        value="<?php echo $row['start_slakom']; ?>"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label" for="jadwal_kickoff">End Jadwal Kick Off Meeting</label>
                                <div class="col-sm-9">
