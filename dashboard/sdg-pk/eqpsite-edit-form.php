...
<body class="text-left">
            ...
            <div class="main-content">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-5">
                            <div class="card-body">
                            <form method="post" action="eqpdev-edit.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <option>Pilih</option>
                                            <option value="Yes" <?php echo ($row['defect_eqpsite'] == 'Yes') ? 'selected' : ''; ?>>Ya</option>
                                            <option value="No" <?php echo ($row['defect_eqpsite'] == 'No') ? 'selected' : ''; ?>>Tidak</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row" id="lampiran_barucp" style="display: none;">
                                <label class="col-sm-3 col-form-label" for="lamp_eqpsite">Upload Baru</label>
                                <div class="col-sm-9">
    ...
    function toggleIssueDetail() {
        var issueSelect = document.getElementById("defect_eqpsite");
        var noteIssue = document.getElementById("notedefect_eqpsite");
