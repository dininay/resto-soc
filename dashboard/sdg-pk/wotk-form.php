...
$sql = "SELECT * from jobadd";

$stmt = $conn->prepare($sql); // Asumsikan id adalah integer, jika bukan sesuaikan tipe datanya
$stmt->execute();
		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Data WO Job Add Less</h1>
                    <ul>
                        <li><a href="href">Edit</a></li>
                        <li>Data WO Job Add Less</li>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-5">
                            <div class="card-body">
                            <form method="post" action="wotk-form-process.php" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                <div class="form-group row">
                                    ...
                                    <select class="form-control" id="kode_lahan" name="kode_lahan">
                                        ...
                                        $sql = "SELECT resto.*, land.* from resto INNER JOIN land ON land.kode_lahan = resto.kode_lahan WHERE status_kom = 'On Going Project'";
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="lamp_wojobadd">Upload Lampiran WO Job Add<strong><span style="color: red;">*</span></strong></label>
                                    <div class="col-sm-9">
                                        <div class="dropzone" id="multple-file-upload" >
                                            <input name="lamp_wojobadd[]" type="file" multiple="multiple" />
                                        </div>
                                    </div>
                                </div>
                                <!-- <div class="form-group row">
