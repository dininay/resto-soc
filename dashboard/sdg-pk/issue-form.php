            ...
            <div class="main-content">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-5">
                            <div class="card-body">
                            <form method="post" action="issue-form-process.php" enctype="multipart/form-data">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="kode_lahan">Nama Resto<span style="color: red;">*</span></label>
                                    <div class="col-sm-9">
                                    <select class="form-control" id="kode_lahan" name="kode_lahan">
                                        <option value="">Pilih Resto</option>
                                        <?php
                                        // Query untuk mengambil kode_lahan dari tabel procurement
                                        $sql = "SELECT land.nama_lahan, issue.kode_lahan From land inner join issue ON issue.kode_lahan = land.kode_lahan";
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while($row = $result->fetch_assoc()) {
                                                echo "<option value='" . $row["kode_lahan"] . "'>" . $row["nama_lahan"] . "</option>";
                                            }
                                        } else {
                                            echo "<option value=''>Tidak ada kode resto tersedia</option>";
                                        }
                                        ?>
                                    </select>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="pic">PIC<span style="color: red;">*</span></label>
                                    <div class="col-sm-9">
                                        <input class="form-control" id="pic" name="pic" type="text" placeholder="PIC" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="target_done">Target Done<span style="color: red;">*</span></label>
                                    <div class="col-sm-9">
                                        <input class="form-control" id="target_done" name="target_done" type="date" placeholder="Target Done" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="issue">Issue Detail<span style="color: red;">*</span></label>
                                    <div class="col-sm-9">
                                        <textarea class="form-control" id="issue" name="issue" rows="4" cols="50"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="lamp_defect">Upload Lampiran Before<span style="color: red;">*</span></label>
                                    <div class="col-sm-9">
                                        <div class="dropzone" id="multple-file-upload" >
                                            <input name="lamp_defect[]" type="file" multiple="multiple" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
