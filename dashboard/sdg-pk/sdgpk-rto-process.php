...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["id"]) && isset($_POST["status_sdg"]) && isset($_POST["catatan_sdg"]) ) {
    $id = $_POST["id"];
    $status_sdg = $_POST["status_sdg"];
    $catatan_sdg = $_POST["catatan_sdg"];
    $sdgpk_date = null;
    ...
    try {
        ...
        if ($status_sdg == 'Approve') {
            ...
            echo "Status berhasil diperbarui.";
                ...
                // Query untuk memperbarui status_sdg, vl_date di tabel re dan memasukkan data ke dalam tabel hold_project
                $sql_update_re = "UPDATE socdate_sdg SET status_sdg = ?, sdgpk_date = ?, catatan_sdg = ? WHERE id = ?";
                $stmt_update_re = $conn->prepare($sql_update_re);
                $stmt_update_re->bind_param("sssi", $status_sdg, $sdgpk_date, $catatan_sdg, $id);
                ...
                $sql = "UPDATE socdate_sdg SET status_sdg = ?, sdgpk_date = ?, catatan_sdg = ? WHERE id = ?";
                $stmt = $conn->prepare($sql);
                $stmt->bind_param("sssi", $status_sdg, $sdgpk_date, $catatan_sdg, $id);
                $stmt->execute();
        ...
        header("Location: ../datatables-sdgpk-rto.php");
