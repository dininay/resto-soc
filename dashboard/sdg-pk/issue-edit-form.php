		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Data Defect Issue List</h1>
                    <ul>
                        <li><a href="href">Edit</a></li>
                        <li>Data Defect Issue List</li>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-5">
                            <div class="card-body">
                            <form method="post" action="issue-edit.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Lampiran BA Defect</label>
                                    <div class="col-sm-9">
                                        <?php echo $row['lamp_badefect']; ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row" id="lampiran_barucp" style="display: none;">
                                    <label class="col-sm-3 col-form-label" for="lamp_badefect">Upload Baru</label>
                                    <div class="col-sm-9">
