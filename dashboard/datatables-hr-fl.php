                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                if (!empty($row['lamp_fl'])) {
                                                    ...
                                                    foreach ($lamp_fl_files as $fl) {
                                                        echo '<li style="display: inline-block; margin-right: 5px;">
                                                                <a href="uploads/' . $fl . '" target="_blank">
                                                ...
                                                <td>
                                                    ...
                                                    $start_date = $row['fl_date'];
                                                    $sla_date = $row['sla_fl'];
                                                    $status_fl = $row['status_fl'];
                                                ...
                                                <td>
                                                    ...
                                                    if ($row['status_fl'] != "Done" && $current_time >= $work_start && $current_time <= $work_end) {
                                                        echo '<a href="hr/hr-fl-edit-form.php?id='. $row['id'] .'" class="btn btn-sm btn-warning mr-2">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a>';
                                                        echo '<button class="btn btn-sm btn-primary edit-btn mr-2" data-toggle="modal" data-target="#editModal" data-id="'. $row['id'] .'" data-status="'.$row['status_fl'] .'">
                                                            <i class="nav-icon i-Book"></i>
                                                        </button>';
                                                        echo '<a href="datatables-data-fl.php?id='. $row['kode_lahan'].'" class="btn btn-sm btn-info">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="hr/fl-process.php" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" id="statusSelect" name="status_fl" Placeholder="Pilih">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="catatan_fl">Catatan FL</label>
                                                                        <input type="text" class="form-control" id="catatan_fl" name="catatan_fl">
                                                                    </div>
