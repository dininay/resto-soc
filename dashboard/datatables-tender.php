                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $status_tender = $row['status_tender'];
                                                ...
                                                <td>
                                                    ...
                                                    if ($row['status_tender'] != "Done") {
                                                        ...
                                                        echo '<button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="'. $row['id'] .'" data-status="'.$row['status_tender'] .'">
                                                    ...
                                                    <!-- Tombol Edit -->
                                                    <!-- <?php if ($row['status_tender'] != "Done"): ?>
                                                        <a href="procurement/procurement-edit-form.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning mr-2">
                                                            <i class="i-Pen-2"></i>
                                                        </a>
