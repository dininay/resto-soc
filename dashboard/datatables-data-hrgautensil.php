...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * from utensil WHERE kode_lahan = ? AND status_utensil = 'Pending In HRGA' OR eta_by = 'Last Updated by HRGA'";
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="hr/datahrga-process.php" enctype="multipart/form-data">
