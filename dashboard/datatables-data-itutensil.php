...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * from utensil WHERE kode_lahan = ? AND status_utensil = 'Pending In IT' OR eta_by = 'Last Updated by IT'";
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="it/datait-process.php" enctype="multipart/form-data">
