...
$sql = "SELECT r.*, l.kode_lahan, l.nama_lahan, l.lokasi, l.lamp_land, l.luas_area, dl.masa_berlaku, dl.deal_sewa
FROM re r
JOIN land l ON r.kode_lahan = l.kode_lahan
LEFT JOIN dokumen_loacd dl ON r.kode_lahan = dl.kode_lahan
...
$sla_query = "SELECT sla FROM master_sla WHERE divisi = 'Negosiator'";
...
if ($sla_result->num_rows > 0) {
    ...
    echo "No SLA value found for 'Negosiator'";
}
                                    ...
                                    <table class="display table table-striped table-bordered" id="zero_configuration_table" style="width:100%">
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <!-- <?php
                                                if (!empty($row['nego_date'])) {
                                                    $date = new DateTime($row['nego_date']);
                                                    $formattedDate = $date->format('d M y');
                                                    echo $formattedDate;
                                                } else {
                                                    echo ''; // Atau biarkan kosong atau pesan lainnya jika diperlukan
                                                }
                                                ?>
                                                <td><?= $formattedDate ?></td> -->
                                                <td>
                                                    ...
                                                    $start_date = $row['nego_date'];
                                                    $sla_date = $row['slanego_date'];
                                                    $status_approvnego = $row['status_approvnego'];
                                                ...
                                                <td>
                                                    ...
                                                    if ($row['status_approvnego'] != "Approve" && $current_time >= $work_start && $current_time <= $work_end) {
                                                        echo '<button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="'. $row['id'] .'" data-status="'.$row['status_approvnego'] .'">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="negosiator/confirm-negosiator-process.php" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status Approve Negosiator<strong><span style="color: red;">*</span></strong></label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="catatan">Catatan Negosiator</label>
                                                                        <input type="text" class="form-control" id="catatan" name="catatan_nego">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="deal_sewa">Deal Harga Sewa<strong><span style="color: red;">*</span></strong></label>
                                                                        <input type="text" class="form-control" id="deal_sewa" name="deal_sewa" oninput="formatRupiah(this)">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="masa_berlaku">Deal Jumlah Tahun Sewa<strong><span style="color: red;">*</span></strong></label>
