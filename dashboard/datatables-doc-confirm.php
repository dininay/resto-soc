		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Datatables Approval Draft Table Sewa</h1>
                </div>
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $slaLegalDate = new DateTime($row['slabod_date']);
                                                    ...
                                                    // Menghitung scoring
                                                    $scoring = calculateScoring($row['bod_date'], $row['slabod_date'], $sla_value); // Make sure $sla_value is set correctly
                                                ...
                                                <td>
                                                    <!-- Tombol Edit -->
                                                    <?php if ($row['confirm_bod'] != "Approve"): ?>
                                                        <div>
                                                        <!-- <a href="owner/draft-sewa-owner-edit-form.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a> -->
                                                        <button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="<?= $row['id'] ?>" data-status="<?= $row['confirm_bod'] ?>">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="owner/draft-sewa-owner-process.php" enctype="multipart/form-data">
                                                                    <input type="hidden" name="id" id="modalId" value="<?= $row['id']; ?>">
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status Approve Draft</label>
                                                                        <select class="form-control" id="statusSelect" name="confirm_bod">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="catatan_bod">Catatan Draft</label>
                                                                        <input type="text" class="form-control" id="catatan_bod" name="catatan_bod">
                                                                    </div>
