                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $start_date = $row['scmipal_date'];
                                                    $sla_date = $row['sla_scmipal'];
                                                    $status_scmipal = $row['status_scmipal'];
                                                ...
                                                <td>
                                                    ...
                                                    if ($row['status_scmipal'] != "Done" && $current_time >= $work_start && $current_time <= $work_end) {
                                                        echo '<a href="scm/scm-ipal-edit-form.php?id='. $row['id'] .'" class="btn btn-sm btn-warning mr-2">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a>';
                                                        echo '<button class="btn btn-sm btn-primary edit-btn mr-2" data-toggle="modal" data-target="#editModal" data-id="'. $row['id'] .'" data-status="'.$row['status_scmipal'] .'">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="scm/scm-ipal-process.php" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status SCM IPAL<strong><span style="color: red;">*</span></strong></label>
