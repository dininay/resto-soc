                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if ($row['status_eqpdevprocur'] == "Approve") {
                                                        ...
                                                        echo '<p>Status changed to Approved on: ' . $row['eqpdevprocur_date'] . '</p>';
                                                    } else {
                                                ...
                                                <td>
                                                    ...
                                                    if ($row['status_eqpdevprocur'] !== 'Approve') : ?>
                                                        <div>
                                                            <!-- <a href="procurement/eqpdev-edit-form.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning mb-2">
                                                                <i class="i-Pen-2"></i>
                                                            </a> -->
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form id="statusForm" method="post" action="procurement/eqpdev-process.php"  enctype="multipart/form-data">
