                        ...
                        <div class="card text-left">
                            <div class="card-body">
								...
								<div class="footer-bottom float-right">
									<p><a class="btn btn-primary btn-icon m-1" href="procurement/vendor-from.php">+ add Vendor </a></p>
									<p>
                                    ...
                                    <table class="display table table-striped table-bordered" id="zero_configuration_table" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>No HP Vendor</th>
                                                <th>Detail</th>
                                                <th>Lampiran Company Profile</th>
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                $lamp_cp_files = explode(",", $row['lamp_profil']); // Pisahkan nama file menjadi array
                                                ...
                                                if (!empty($row['lamp_profil'])) {
                                                    ...
                                                    foreach ($lamp_cp_files as $cp) {
                                                        echo '<li style="display: inline-block; margin-right: 5px;">
                                                                <a href="uploads/' . $cp . '" target="_blank">
