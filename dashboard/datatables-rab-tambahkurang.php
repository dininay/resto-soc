...
WHERE status_rabjobadd IN ('Approve', 'Done','In Process', 'Pending')";
		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Data RAB Pekerjaan Tambah Kurang</h1>
                </div>
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $start_date = $row['rabjobadd_date'];
                                                    $sla_date = $row['sla_rabjobadd'];
                                                    $status_rabjobadd = $row['status_rabjobadd'];
                                                ...
                                                <td>
                                                    <!-- Tombol Edit -->
                                                    <?php if ($row['status_rabjobadd'] != "Approve"): ?>
                                                    <?php
                                                    // Mengatur timezone ke Asia/Jakarta (sesuaikan dengan timezone lokal Anda)
                                                    date_default_timezone_set('Asia/Jakarta');
                                                    ...
                                                    if ($row['status_rabjobadd'] != "Approve") {
                                                        echo '<a href="sdg-qs/rabtk-edit-form.php?id='. $row['id'] .'" class="btn btn-sm btn-warning mr-2">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a>';
                                                        echo '<button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="'. $row['id'] .'" data-status="'.$row['status_rabjobadd'] .'">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="sdg-qs/rabtk-process.php" enctype="multipart/form-data">
                                                                    <input type="hidden" name="id" id="modalKodeLahan">
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status Approve RAB<strong><span style="color: red;">*</span></strong></label>
                                                                        <select class="form-control" id="statusSelect" name="status_rabjobadd" Placeholder="Pilih">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="catatan_rabjobadd">Catatan</label>
                                                                        <input type="text" class="form-control" id="catatan_rabjobadd" name="catatan_rabjobadd">
                                                                    </div>
