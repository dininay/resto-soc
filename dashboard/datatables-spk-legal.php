...
$sql = "SELECT l.kode_lahan, l.nama_lahan, l.lokasi, l.lamp_land, d.lamp_draf, c.lamp_loacd, p.status_approvprocurement, 
        ...
        c.lamp_vd, q.lamp_rab, c.status_approvlegalvd, s.lamp_pbg, s.lamp_permit, s.submit_legal, d.valdoc_legal, r.status_legalizin
        FROM draft d
        ...
        WHERE r.status_legalizin IN ('In Process', 'Approve', 'Pending')";
		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Permission SPK from Procurement</h1>
                </div>
                        ...
                        <div class="card text-left">
                            <div class="card-body">
								...
								<div class="footer-bottom float-right">
									<!-- <p><a class="btn btn-primary btn-icon m-1" href="legal/permit-from.php">+ add Data </a></p> -->
									<p>
                              ...
                              <table class="display table table-striped table-bordered" id="zero_configuration_table" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Lampiran Legal Izin</th>
                                                <th>Status Legal Izin</th>
                                                <th>SLA</th>
												<th>Action</th>
                                            </tr>
                                        </thead>
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <?php
                                                // Bagian ini di dalam loop yang menampilkan data tabel
                                                $lamp_legalizin_files = explode(",", $row['lamp_legalizin']); // Pisahkan nama file menjadi array
                                                // Periksa apakah array tidak kosong sebelum menampilkan ikon
                                                if (!empty($row['lamp_legalizin'])) {
                                                    echo '<td>
                                                            <ul style="list-style-type: none; padding: 0; margin: 0;">';
                                                    // Loop untuk setiap file dalam array
                                                    foreach ($lamp_legalizin_files as $lamp_legalizin) {
                                                        echo '<li style="display: inline-block; margin-right: 5px;">
                                                                <a href="uploads/' . $lamp_legalizin . '" target="_blank">
                                                                    <i class="fas fa-file-pdf nav-icon"></i>
                                                                </a>
                                                            </li>';
                                                    }
                                                ...
                                                <td>
                                                    ...
                                                    $slaLegalDate = new DateTime($row['sla_spk']);
                                                ...
                                                <td>
                                                    <!-- Tombol Edit -->
                                                    <?php if ($row['status_legalizin'] != "Approve"): ?>
                                                        <div>
                                                        <a href="legal/spk-legal-edit-form.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning mb-2">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a>
                                                        <button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="<?= $row['id'] ?>" data-status="<?= $row['status_legalizin'] ?>">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="legal/izin-konstruksi-process.php"  enctype="multipart/form-data">
                                                                    <input type="hidden" name="id" id="modalId" value="<?= $row['id']; ?>">
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status Approve SPK Legal</label>
                                                                        <select class="form-control" id="statusSelect" name="status_legalizin">
...
<?php if ($status_legalizin == 'Pending') { ?>
    <script>
        $(document).ready(function () {
