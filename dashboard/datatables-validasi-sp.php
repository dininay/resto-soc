...
b.confirm_sdgqs, b.lamp_rab, c.kode_store, s.lamp_permit, s.lamp_pbg
        FROM draft d
        ...
        INNER JOIN sdg_rab b ON r.kode_lahan = b.kode_lahan
        WHERE s.submit_legal IN ('In Process', 'Pending', 'Approve')";
		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Datatables Surat Pernyataan Submit Legal</h1>
                </div>
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                if (!empty($row['lamp_rab'])) {
                                                    ...
                                                    foreach ($lamp_rab_files as $sprab) {
                                                        echo '<li style="display: inline-block; margin-right: 5px;">
                                                                <a href="uploads/' . $sprab . '" target="_blank">
                                                                    <i class="fas fa-file-pdf nav-icon"></i>
                                                                </a>
                                                            </li>';
                                                    }
