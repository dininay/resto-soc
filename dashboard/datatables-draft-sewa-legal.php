...
if ($sla_result->num_rows > 0) {
    ...
    echo "No SLA value found for 'Table Sewa'";
}
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $start_date = $row['draftre_date'];
                                                    $sla_date = $row['sladraftre_date'];
                                                    $confirm_re = $row['confirm_re'];
                                                ...
                                                <td>
                                                    ...
                                                    if ($row['confirm_re'] != "Approve" && $current_time >= $work_start && $current_time <= $work_end) {
                                                        echo '<a href="legal/draft-sewa-edit-form.php?id='. $row['id'] .'" class="btn btn-sm btn-warning mr-2">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a>';
                                                        echo '<button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="'. $row['id'] .'" data-status="'.$row['confirm_re'] .'">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="legal/draft-sewa-process.php" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status Draft Table<strong><span style="color: red;">*</span></strong></label>
                                                                        <select class="form-control" id="statusSelect" name="confirm_re">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="catatan_re">Catatan Review PSM</label>
                                                                        <input type="text" class="form-control" id="catatan_re" name="catatan_re">
                                                                    </div>
