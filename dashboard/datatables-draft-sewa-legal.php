                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $slaLegalDate = new DateTime($row['sladraftre_date']);
                                                    ...
                                                    // Menghitung scoring
                                                    $scoring = calculateScoring($row['draftre_date'], $row['sladraftre_date'], $sla_value); // Make sure $sla_value is set correctly
                                                    $remarks = getRemarks($scoring);

                                                    if ($row['confirm_re'] == "Done") {
                                                ...
                                                <td>
                                                    ...
                                                    <?php if ($row['confirm_re'] != "Done"): ?>
                                                        ...
                                                        <button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="<?= $row['id'] ?>" data-status="<?= $row['confirm_re'] ?>">
