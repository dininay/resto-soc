...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT crewqc.*, socdate_hraca.sla_tmaca FROM crewqc INNER JOIN socdate_hraca ON socdate_hraca.kode_lahan = crewqc.kode_lahan WHERE crewqc.kode_lahan = ? AND status_lolos = 'Siap Training'";
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="academy/datacrewqsa-process.php" enctype="multipart/form-data">
                                                ...
                                                <div class="modal fade" id="editModal2" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="academy/datacrewqsb-process.php" enctype="multipart/form-data">
