...
if ($sla_result->num_rows > 0) {
    ...
    echo "No SLA value found for 'ST-Konstruksi'";
}
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $start_date = $row['stkonstruksi_date'];
                                                    $sla_date = $row['sla_stkonstruksi'];
                                                    $status_stkonstruksi = $row['status_stkonstruksi'];
                                                ...
                                                <td>
                                                    <!-- Tombol Edit -->
                                                    <?php if ($row['status_stkonstruksi'] != "Done"): ?>
                                                    <?php
                                                    // Mengatur timezone ke Asia/Jakarta (sesuaikan dengan timezone lokal Anda)
                                                    date_default_timezone_set('Asia/Jakarta');
                                                    ...
                                                    if ($row['status_stkonstruksi'] != "Done" && $current_time >= $work_start && $current_time <= $work_end && $interval <= 30 && $interval >= 0) {
                                                        echo '<a href="sdg-pk/stkons-edit-form.php?id='. $row['id'] .'" class="btn btn-sm btn-warning mr-2">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a>';
                                                        echo '<button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="'. $row['id'] .'" data-status="'.$row['status_stkonstruksi'] .'">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form id="statusForm" method="post" action="sdg-pk/stkons-process.php"  enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="statusSelect">Status Approve ST Kontraktor<strong><span style="color: red;">*</span></strong></label>
