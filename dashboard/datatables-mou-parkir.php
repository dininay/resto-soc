...
$sql = "SELECT socdate_legal.*, dokumen_loacd.* from socdate_legal
join dokumen_loacd ON dokumen_loacd.kode_lahan = socdate_legal.kode_lahan";
...
$sla_query = "SELECT sla FROM master_slacons WHERE divisi = 'legal'";
...
if ($sla_result->num_rows > 0) {
    ...
    echo "No SLA value found for 'legal'";
}
                        ...
                        <div class="card text-left">
                            <div class="card-body">
								...
								<div class="footer-bottom float-right">
									<!-- <p><a class="btn btn-primary btn-icon m-1" href="legal/mouparkir-from.php">+ add Data </a></p> -->
									<p>
                                    ...
                                    <table class="display table table-striped table-bordered" id="zero_configuration_table" style="width:100%">
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                $mou_parkirsampah_files = explode(",", $row['mou_parkirsampah']); // Pisahkan nama file menjadi array
                                                // Periksa apakah array tidak kosong sebelum menampilkan ikon
                                                if (!empty($row['mou_parkirsampah'])) {
                                                    echo '<td>
                                                            <ul style="list-style-type: none; padding: 0; margin: 0;">';
                                                    // Loop untuk setiap file dalam array
                                                    foreach ($mou_parkirsampah_files as $mps) {
                                                        echo '<li style="display: inline-block; margin-right: 5px;">
                                                                <a href="uploads/' . $mps . '" target="_blank">
                                                ...
                                                <td>
                                                    ...
                                                    $start_date = $row['sampahparkir_date'];
                                                    $sla_date = $row['sla_legal'];
                                                ...
                                                <td>
                                                    ...
                                                    if ($row['status_legal'] != "Done" && $current_time >= $work_start && $current_time <= $work_end) {
                                                        echo '<a href="legal/mouparkir-edit-form.php?id='. $row['id'] .'" class="btn btn-sm btn-warning mr-2">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a>';
                                                        echo '<button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="'. $row['id'] .'" data-status="'.$row['status_legal'] .'">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="legal/mouparkir-process.php" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" id="statusSelect" name="status_legal" Placeholder="Pilih">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="catatan_legal">Catatan Legal</label>
                                                                        <input type="text" class="form-control" id="catatan_legal" name="catatan_legal">
                                                                    </div>
