		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Data WO Pekerjaan Tambah Kurang</h1>
                </div>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                ...
                                <p><a class="btn btn-primary btn-icon m-1" href="sdg-pk/wotk-form.php">+ add Pekerjaan +-</a></p>
									<p>
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $start_date = $row['wojobadd_date'];
                                                    $sla_date = $row['sla_wojobadd'];
                                                    $status_wojobadd = $row['status_wojobadd'];
                                                ...
                                                <td>
                                                    <!-- Tombol Edit -->
                                                    <?php if ($row['status_wojobadd'] != "Approve"): ?>
                                                    <?php
                                                    // Mengatur timezone ke Asia/Jakarta (sesuaikan dengan timezone lokal Anda)
                                                    date_default_timezone_set('Asia/Jakarta');
                                                    ...
                                                    if ($row['status_wojobadd'] != "Approve") {
                                                        echo '<a href="sdg-pk/wotk-edit-form.php?id='. $row['id'] .'" class="btn btn-sm btn-warning mr-2">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a>';
                                                        // echo '<button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="'. $row['id'] .'" data-status="'.$row['status_wojobadd'] .'">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="sdg-pk/wotk-process.php" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" id="statusSelect" name="status_wojobadd" Placeholder="Pilih">
