...
$sql = "SELECT socdate_marketing.*, land.nama_lahan, dokumen_loacd.kode_store 
from socdate_marketing
inner join land ON land.kode_lahan = socdate_marketing.kode_lahan
inner join dokumen_loacd ON dokumen_loacd.kode_lahan = socdate_marketing.kode_lahan";
		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Data Gmaps, Merchant, Email Resto</h1>
                </div>
                        ...
                        <div class="card text-left">
                            <div class="card-body">
								...
								<div class="footer-bottom float-right">
									<!-- <p><a class="btn btn-primary btn-icon m-1" href="marketing/marketing-from.php">+ add Data </a></p> -->
									<p>
                                    ...
                                    <table class="display table table-striped table-bordered" id="zero_configuration_table" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Kode Store</th>
                                                <th>Link Gmaps</th>
                                                <th>Lampiran Gmaps</th>
                                                <th>ID Merchant Gojek</th>
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                $lamp_gmaps_files = explode(",", $row['lamp_gmaps']); // Pisahkan nama file menjadi array
                                                // Periksa apakah array tidak kosong sebelum menampilkan ikon
                                                if (!empty($row['lamp_gmaps'])) {
                                                    echo '<td>
                                                            <ul style="list-style-type: none; padding: 0; margin: 0;">';
                                                    // Loop untuk setiap file dalam array
                                                    foreach ($lamp_gmaps_files as $sj) {
                                                ...
                                                <td>
                                                    ...
                                                    $start_date = $row['marketing_date'];
                                                    $sla_date = $row['sla_marketing'];
                                                ...
                                                <td>
                                                    <!-- Tombol Edit -->
                                                    <?php if ($row['status_marketing'] != "Done"): ?>
                                                    <?php
                                                    // Mengatur timezone ke Asia/Jakarta
                                                    date_default_timezone_set('Asia/Jakarta');
                                                    ...
                                                    if ($row['status_marketing'] != "Done" && $current_time >= $work_start && $current_time <= $work_end) {
                                                        echo '<a href="marketing/marketing-edit-form.php?id='. $row['id'] .'" class="btn btn-sm btn-warning mr-2">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a>';
                                                        echo '<button class="btn btn-sm btn-primary edit-btn mr-2" data-toggle="modal" data-target="#editModal" data-id="'. $row['id'] .'" data-status="'.$row['status_marketing'] .'">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="marketing/marketing-process.php" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status Marketing<strong><span style="color: red;">*</span></strong></label>
