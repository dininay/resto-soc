...
$sla_query = "SELECT sla FROM master_sla WHERE divisi = 'Urugan'";
...
if ($sla_result->num_rows > 0) {
    ...
    echo "No SLA value found for 'Urugan'";
}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if ($row['confirm_sdgurugan'] != "Approve" && $current_time >= $work_start && $current_time <= $work_end) {
                                                        ...
                                                        echo '<button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="'. $row['id'] .'" data-status="'.$row['confirm_sdgurugan'] .'">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="sdg-design/urugan-process.php" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status SDG Design<strong><span style="color: red;">*</span></strong></label>
