                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                    <span class="badge rounded-pill badge-<?php echo $badge_color; ?>">
                                                        <?php echo $row['status_spkwofat']; ?>
                                                    </span>
                                                </td>
                                                <td>
                                                    <?php
                                                    // Mendapatkan tanggal sla_date dari kolom data
                                                    $slaLegalDate = new DateTime($row['sla_spkwofat']);
                                                    ...
                                                    if ($today->format('N') == 6 || $today->format('N') == 7) { // N = 6 is Saturday, N = 7 is Sunday
                                                        ...
                                                        // Menghitung scoring
                                                        $scoring = calculateScoring($row['spkwofat_date'], $row['sla_spkwofat'], $sla_value); // Make sure $sla_value is set correctly
                                                        $remarks = getRemarks($scoring);

                                                        if ($row['status_spkwofat'] == "Approve") {
                                                ...
                                                <td>
                                                    <?php if ($row['status_spkwofat'] != "Approve"): ?>
                                                            <!-- <a href="procurement/spk-wodesign-procur-edit-form.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning mr-2">
                                                            <i class="i-Pen-2"></i>
                                                            </a> -->
                                                        <button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="<?= $row['id'] ?>" data-status="<?= $row['status_spkwofat'] ?>">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="fat/spk-wodesign-fat-process.php" enctype="multipart/form-data">
                                                                    <input type="hidden" name="id" id="modalKodeLahan">
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status Review SPK Design<strong><span style="color: red;">*</span></strong></label>
                                                                        <select class="form-control" id="statusSelect" name="status_spkwofat">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="catatan_spkwofat">Catatan TAF</label>
                                                                        <input type="text" class="form-control" id="catatan_spkwofat" name="catatan_spkwofat">
                                                                    </div>
