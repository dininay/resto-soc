...
WHERE status_procurspkwofa IN ('Approve', 'In Review By TAF', 'Pending')";
		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Data Review SPK MEP - Filter Air</h1>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                if (!empty($row['lamp_spkwofilterair'])) {
                                                    echo '<td>
                                                            <ul style="list-style-type: none; padding: 0; margin: 0;">';
                                                    // Loop untuk setiap file dalam array
                                                    foreach ($lamp_spkwofilterair_files as $listrik) {
                                                        echo '<li style="display: inline-block; margin-right: 5px;">
                                                                <a href="uploads/' . $listrik . '" target="_blank">
                                                                    <i class="fas fa-file-pdf nav-icon"></i>
                                                                </a>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="badge rounded-pill badge-<?php echo $badge_color; ?>">
                                                        <?php echo $row['status_spkfataf']; ?>
                                                    </span>
                                                </td>
                                                <td>
                                                    <?php
                                                    // Mendapatkan tanggal sla_date dari kolom data
                                                    $slaLegalDate = new DateTime($row['sla_spkfataf']);
                                                    ...
                                                    if ($today->format('N') == 6 || $today->format('N') == 7) { // N = 6 is Saturday, N = 7 is Sunday
                                                        ...
                                                        // Menghitung scoring
                                                        $scoring = calculateScoring($row['spkfataf_date'], $row['sla_spkfataf'], $sla_value); // Make sure $sla_value is set correctly
                                                        $remarks = getRemarks($scoring);

                                                        if ($row['status_spkfataf'] == "Approve") {
                                                ...
                                                <td>
                                                <!-- Tombol Edit -->
                                                <?php if ($row['status_spkfataf'] != "Approve"): ?>
                                                        <!-- <a href="procurement/spkfa-procur-edit-form.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning mr-2">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a> -->
                                                        <button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="<?= $row['id'] ?>" data-status="<?= $row['status_spkfataf'] ?>">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="fat/spkfa-fat-process.php" enctype="multipart/form-data">
                                                                    <input type="hidden" name="id" value=<?= $row['id'] ?> id="modalKodeLahan">
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status SPK Filter Air<strong><span style="color: red;">*</span></strong></label>
                                                                        <select class="form-control" id="statusSelect" name="status_spkfataf" Placeholder="Pilih">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="catatan_spkfataf">Catatan SPK Filter Air</label>
                                                                        <input type="text" class="form-control" id="catatan_spkfataf" name="catatan_spkfataf">
                                                                    </div>
