		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Data RAB Job Add Less</h1>
                    <ul>
                        <li><a href="href">Edit</a></li>
                        <li>Data RAB Job Add Less</li>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-5">
                            <div class="card-body">
                            <form method="post" action="rabtk-edit.php" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="lamp_rabjobadd">Upload Lampiran RAB Job Add<strong><span style="color: red;">*</span></strong></label>
                                    <div class="col-sm-9">
                                        <div class="dropzone" id="multple-file-upload" >
                                            <input name="lamp_rabjobadd[]" type="file" multiple="multiple" />
                                        </div>
                                    </div>
                                </div>
                                <!-- <div class="form-group row">
