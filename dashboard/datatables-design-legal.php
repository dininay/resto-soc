...
$sql = "SELECT sdg_desain.*, dokumen_loacd.kode_store, land.nama_lahan
 FROM sdg_desain 
...
$sla_query = "SELECT sla FROM master_sla WHERE divisi = 'Obstacle Legal'";
...
if ($sla_result->num_rows > 0) {
    ...
    echo "No SLA value found for 'Obstacle Legal'";
}
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $start_date = $row['obslegal_date'];
                                                    $sla_date = $row['sla_obslegal'];
                                                    $status_obslegal = $row['status_obslegal'];
                                                ...
                                                <td>
                                                    <!-- Tombol Edit -->
                                                    <?php if ($row['status_obslegal'] != "Approve"): ?>
                                                    <?php
                                                    // Mengatur timezone ke Asia/Jakarta (sesuaikan dengan timezone lokal Anda)
                                                    date_default_timezone_set('Asia/Jakarta');
                                                    ...
                                                    if ($row['status_obslegal'] != "Done") {
                                                        ...
                                                        echo '<button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="'. $row['id'] .'" data-status="'.$row['status_obslegal'] .'">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="legal/obstacle-legal-process.php"  enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" id="statusSelect" name="status_obslegal" Placeholder="Pilih">
...
<?php if ($status_obslegal == 'Pending') { ?>
    <script>
        $(document).ready(function () {
