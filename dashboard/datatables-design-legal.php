                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $slaLegalDate = new DateTime($row['sla_obslegal']);
                                                    ...
                                                    // Menghitung scoring
                                                    $scoring = calculateScoring($row['obslegal_date'], $row['sla_obslegal'], $sla_value); // Make sure $sla_value is set correctly
                                                    $remarks = getRemarks($scoring);

                                                    if ($row['status_obslegal'] == "Approve") {
