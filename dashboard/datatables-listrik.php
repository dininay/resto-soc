...
JOIN resto r ON socdate_sdg.kode_lahan = r.kode_lahan
JOIN dokumen_loacd d ON socdate_sdg.kode_lahan = d.kode_lahan
WHERE status_tafpaylistrik IN ('In Process', 'Paid', 'Pending')";
...
$sla_query = "SELECT sla FROM master_slacons WHERE divisi = 'payment-taf'";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                        ...
                                                        $badge_color = '';
                                                        switch ($row['status_tafpaylistrik']) {
                                                            case 'Paid':
                                                                $badge_color = 'success';
                                                                break;
                                                            case 'Pending':
                                                ...
                                                <td>
                                                    ...
                                                    $start_date = $row['tafpaylistrik_date'];
                                                    $sla_date = $row['sla_tafpaylistrik'];
                                                    $status_tafpaylistrik = $row['status_tafpaylistrik'];
                                                ...
                                                <td>
                                                    <!-- Tombol Edit -->
                                                    <?php if ($row['status_tafpaylistrik'] != "Paid"): ?>
                                                    <?php
                                                    ...
                                                    if ($row['status_tafpaylistrik'] != "Paid" && $current_day >= 1 && $current_day <= 5) {
                                                        echo '<a href="fat/tafpaylistrik-edit-form.php?id='. $row['id'] .'" class="btn btn-sm btn-warning mr-2">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a>';
                                                        echo '<button class="btn btn-sm btn-primary edit-btn mr-2" data-toggle="modal" data-target="#editModal" data-id="'. $row['id'] .'" data-status="'.$row['status_tafpaylistrik'] .'">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="fat/tafpaylistrik-process.php" enctype="multipart/form-data">
                                                                    <input type="hidden" name="id" value=<?= $row['id'] ?> id="modalKodeLahan">
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status Payment TAF<strong><span style="color: red;">*</span></strong></label>
                                                                        <select class="form-control" id="statusSelect" name="status_tafpaylistrik" Placeholder="Pilih">
