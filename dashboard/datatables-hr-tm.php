							  ...
							  <div class="table-responsive">
                                    <table class="display table table-striped table-bordered" id="zero_configuration_table" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>Kode Lahan</th>
                                                <th>Data Technical Meeting</th>
                                                <th>Lampiran Technical Meeting</th>
                                                <th>Status</th>
                                                <th>SLA</th>
												<th>Action</th>
                                            </tr>
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $slaDate = new DateTime($row['sla_tm']);
                                                    ...
                                                    if ($row['status_tm'] == "Approve") {
                                                        ...
                                                        echo '<p>Status changed to Approved on: ' . $row['tm_date'] . '</p>';
                                                    } else {
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="hr/tm-process.php" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status Approve TM</label>
