...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT crew.*, socdate_academy.sla_kpt1 FROM crew INNER JOIN socdate_academy ON socdate_academy.kode_lahan = crew.kode_lahan WHERE crew.kode_lahan = ? AND status_lolos = 'Siap Training'";
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="academy/datacrewkpt1a-process.php" enctype="multipart/form-data">
                                                ...
                                                <div class="modal fade" id="editModal2" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="academy/datacrewkpt1b-process.php" enctype="multipart/form-data">
