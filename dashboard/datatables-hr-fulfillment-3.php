...
WHERE status_ff3 IN ('In Process', 'Pending', 'Done')";
...
$sla_query = "SELECT sla FROM master_slacons WHERE divisi = 'hrga_ff3'";
...
if ($sla_result->num_rows > 0) {
    ...
    echo "No SLA value found for 'hrga_ff3'";
}
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                if (!empty($row['lamp_ff3'])) {
                                                    ...
                                                    foreach ($lamp_ff3_files as $ff3) {
                                                        echo '<li style="display: inline-block; margin-right: 5px;">
                                                                <a href="uploads/' . $ff3 . '" target="_blank">
                                                ...
                                                <td>
                                                    ...
                                                    $start_date = $row['ff3_date'];
                                                    $sla_date = $row['sla_ff3'];
                                                    $status_ff3 = $row['status_ff3'];
                                                ...
                                                <td>
                                                    ...
                                                    if ($row['status_ff3'] != "Done" && $current_time >= $work_start && $current_time <= $work_end) {
                                                        echo '<a href="hr/hr-ff3-edit-form.php?id='. $row['id'] .'" class="btn btn-sm btn-warning mr-2">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a>';
                                                        echo '<button class="btn btn-sm btn-primary edit-btn mr-2" data-toggle="modal" data-target="#editModal" data-id="'. $row['id'] .'" data-status="'.$row['status_ff3'] .'">
                                                            <i class="nav-icon i-Book"></i>
                                                        </button>';
                                                        echo '<a href="datatables-data-ff3.php?id='. $row['kode_lahan'].'" class="btn btn-sm btn-info">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="hr/ff3-process.php" enctype="multipart/form-data">
                                                                    <input type="hidden" name="id" value=<?= $row['id'] ?> id="modalKodeLahan">
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status FF 3<strong><span style="color: red;">*</span></strong></label>
                                                                        <select class="form-control" id="statusSelect" name="status_ff3" Placeholder="Pilih">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="catatan_ff3">Catatan FF 3</label>
                                                                        <input type="text" class="form-control" id="catatan_ff3" name="catatan_ff3">
                                                                    </div>
