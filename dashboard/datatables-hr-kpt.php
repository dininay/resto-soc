                                    ...
                                    <table class="display table table-striped table-bordered" id="zero_configuration_table" style="width:100%">
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                $lamp_kpt1_files = explode(",", $row['lamp_kpt1']); // Pisahkan nama file menjadi array
                                                // Periksa apakah array tidak kosong sebelum menampilkan ikon
                                                if (!empty($row['lamp_kpt1'])) {
                                                    echo '<td>
                                                            <ul style="list-style-type: none; padding: 0; margin: 0;">';
                                                    // Loop untuk setiap file dalam array
                                                    foreach ($lamp_kpt1_files as $kpt1) {
                                                        echo '<li style="display: inline-block; margin-right: 5px;">
                                                                <a href="uploads/' . $kpt1 . '" target="_blank">
                                                ...
                                                <td>
                                                    ...
                                                    $slaDate = new DateTime($row['sla_kpt1']);
                                                ...
                                                <td>
                                                <!-- Tombol Edit -->
                                                <?php if ($row['status_kpt1'] != "Approve"): ?>
                                                        <a href="academy/kpt1-edit-form.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a>
                                                    <?php endif; ?>
                                                    <?php if ($row['status_kpt1'] != "Approve"): ?>
                                                        <button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="<?= $row['id'] ?>" data-status="<?= $row['status_kpt1'] ?>">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="academy/kpt1-process.php" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status Approve KPT 1</label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="catatan_kpt1">Catatan KPT 1</label>
                                                                        <input type="text" class="form-control" id="catatan_kpt1" name="catatan_kpt1">
                                                                    </div>
