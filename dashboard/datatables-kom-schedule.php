...
$sql = "SELECT d.lamp_draf, d.lamp_signpsm, o.kode_lahan, 
               l.nama_lahan, l.lokasi, l.lamp_land, o.id,
               dl.lamp_loacd, dl.lamp_vd, dl.kode_store,
               r.lamp_vl, o.status_schedule, o.schedule_date, o.sla_kom
        FROM draft d
        ...
        LEFT JOIN resto o ON o.kode_lahan = d.kode_lahan
        LEFT JOIN procurement p ON p.kode_lahan = d.kode_lahan
        WHERE p.status_tender = 'Done'";
		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Datatables Scheduling Kick Off Meeting</h1>
                </div>
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                if (!empty($row['sla_kom'])) {
                                                    ...
                                                    echo "<td></td>"; // Atau biarkan kosong atau tambahkan placeholder jika diperlukan
                                                }
                                                ?>
                                                <td>
                                                    <?php
                                                ...
                                                <td>
                                                    <!-- Tombol Edit -->
                                                        <div>
                                                        <a href="sdg-pk/kom-schedule-edit-form.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning mr-2">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a>
                                                        <?php if ($row['status_schedule'] != "Approve" && $row['status_schedule'] != "Approve Update"): ?>
                                                        <button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="<?= $row['id'] ?>" data-status="<?= $row['status_schedule'] ?>">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="sdg-pk/schedule-kom-process.php" enctype="multipart/form-data">
                                                                    <input type="hidden" name="id" id="modalKodeLahan" value="<?= $row['id']; ?>">
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status Schedule<strong><span style="color: red;">*</span></strong></label>
                                                                        <select class="form-control" id="statusSelect" name="status_schedule">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="catatan_schedule">Catatan Schedule</label>
                                                                        <input type="text" class="form-control" id="catatan_schedule" name="catatan_schedule">
                                                                    </div>
...
<?php if ($status_schedule == 'Pending') { ?>
    <script>
        $(document).ready(function () {
