		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Data EQP (Pylon, Brankas, CS & Chiller)</h1>
                </div>
                        ...
                        <div class="card text-left">
                            <div class="card-body">
								...
								<div class="footer-bottom float-right">
									<!-- <p><a class="btn btn-primary btn-icon m-1" href="sdg-pk/eqp-rto-from.php">+ add Data </a></p> -->
									<p>
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            ...
                                            <td>
                                                <td>
                                                    ...
                                                    $slaDate = new DateTime($row['sla_sdggpk']);
                                                ...
                                                <td>
                                                <!-- Tombol Edit -->
                                                <?php if ($row['status_sdgeqp'] != "Approve"): ?>
                                                        <a href="sdgpk/sdgpk-rto-edit-form.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning mr-2">
                                                ...
                                                <?php if ($row['status_sdgeqp'] != "Approve"): ?>
                                                    ...
                                                    <form method="post" action="" class="status-form" style="display: none; margin-top: 10px;">
                                                        ...
                                                        <select class="form-control" name="status_sdgeqp" onchange="this.form.submit()">
                                                            <option value="In Process" <?= $row['status_sdgeqp'] == 'In Process' ? 'selected' : '' ?>>In Process</option>
                                                            <option value="Pending" <?= $row['status_sdgeqp'] == 'Pending' ? 'selected' : '' ?>>Pending</option>
                                                            <option value="Approve" <?= $row['status_sdgeqp'] == 'Approve' ? 'selected' : '' ?>>Approve</option>
                                                        </select>
                                                    </form>
                                                <?php endif; ?>
                                                </td>
