...
$sql = "SELECT l.kode_lahan, l.nama_lahan, l.lokasi, l.lamp_land, c.lamp_loacd, d.lamp_draf, p.id, c.kode_store, v.nama,
        ...
        WHERE p.status_fattender IN ('In Process', 'Approve', 'Pending')";
                                            ...
                                            <tr>
                                                ...
                                                if (!empty($row['lamp_vendor'])) {
                                                    echo '<td>
                                                            <ul style="list-style-type: none; padding: 0; margin: 0;">';
                                                    // Loop untuk setiap file dalam array
                                                    foreach ($lamp_vendor_files as $vendor) {
                                                        echo '<li style="display: inline-block; margin-right: 5px;">
                                                ...
                                                <td>
                                                    ...
                                                    $slaLegalDate = new DateTime($row['sla_fattender']);
                                                    ...
                                                    if ($row['status_fattender'] == "Approve") {
                                                ...
                                                <td>
                                                    <!-- Tombol Edit -->
                                                    <?php if ($row['status_fattender'] != "Approve"): ?>
                                                        <!-- <a href="procurement/procurement-edit-form.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning mb-2">
                                                            <i class="i-Pen-2"></i>
                                                        </a> -->
                                                        <button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="<?= $row['id'] ?>" data-status="<?= $row['status_fattender'] ?>">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="fat/tender-process.php" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" id="statusSelect" name="status_fattender" Placeholder="Pilih">
                                                                            <option value="In Process">In Process</option>
                                                                            <option value="Pending">Pending</option>
                                                                            <option value="Approve">Signed</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="catatan_fattender">Catatan Procurement</label>
                                                                        <input type="text" class="form-control" id="catatan_fattender" name="catatan_fattender">
                                                                    </div>
