                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $slaLegalDate = new DateTime($row['sla_spkwo']);
                                                    ...
                                                    // Menghitung scoring
                                                    $scoring = calculateScoring($row['spkwo_date'], $row['sla_spkwo'], $sla_value); // Make sure $sla_value is set correctly
                                                    $remarks = getRemarks($scoring);

                                                    if ($row['status_spkwo'] == "In Review By TAF" || $row['status_spkwo'] == "Approve") {
                                                ...
                                                <td>
                                                    <?php if ($row['status_spkwo'] != "Approve"): ?>
                                                        ...
                                                        <button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="<?= $row['id'] ?>" data-status="<?= $row['status_spkwo'] ?>">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="procurement/spk-wodesign-procur-process.php" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status SPK WO Design</label>
