		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Data MEP - IPAL Evaluation</h1>
                </div>
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $start_date = $row['sdgipal_date'];
                                                    $sla_date = $row['sla_mep'];
                                                    $status_sdgipal = $row['status_sdgipal'];
                                                ...
                                                <td>
                                                    <!-- Tombol Edit -->
                                                    <?php if ($row['status_sdgipal'] != "Done"): ?>
                                                    <?php
                                                    // Mengatur timezone ke Asia/Jakarta (sesuaikan dengan timezone lokal Anda)
                                                    date_default_timezone_set('Asia/Jakarta');
                                                    ...
                                                    if ($row['status_sdgipal'] != "Done" && $current_time >= $work_start && $current_time <= $work_end) {
                                                        echo '<a href="sdg-pk/sdgpk-rto-ipal-edit-form.php?id='. $row['id'] .'" class="btn btn-sm btn-warning mr-2">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a>';
                                                        // echo '<button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="'. $row['id'] .'" data-status="'.$row['status_sdgipal'] .'">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="sdg-pk/sdgpk-rto-process.php" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" id="statusSelect" name="status_sdgipal" Placeholder="Pilih">
