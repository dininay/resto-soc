                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if ($row['status_eqpsite'] !== 'Approve') : ?>
                                                        <div>
                                                            <a href="sdg-pk/eqpsite-edit-form.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning mb-2">
                                                                <i class="i-Pen-2"></i>
                                                            </a>
                                                                ...
                                                                <div class="modal-body">
                                                                    <form id="statusForm" method="post" action="sdg-pk/eqpsite-process.php"  enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="statusSelect">Status Approve EQP On Site</label>
