                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $slaLegalDate = new DateTime($row['sla_eqpsite']);
                                                    
                                                    // Mendapatkan tanggal hari ini
                                                    $today = new DateTime();
                                                    
                                                    // Menghitung selisih hari antara sla_eqpsite dan hari ini
                                                    $diff = $today->diff($slaLegalDate);
                                                    
                                                    // Menghitung scoring
                                                    $scoring = calculateScoring($row['eqpsite_date'], $row['sla_eqpsite'], $sla_value); // Make sure $sla_value is set correctly
                                                    $remarks = getRemarks($scoring);

                                                    if ($row['status_eqpsite'] == "Done") {
                                                ...
                                                <td>
                                                    ...
                                                    $sla_steqp = new DateTime($row['sla_eqpsite']);
                                                    ...
                                                    if ($row['status_eqpsite'] !== 'Done') : ?>
                                                        <div>
                                                            <a href="sdg-pk/eqpsite-edit-form.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning">
                                                                <i class="i-Pen-2"></i>
                                                            </a>
                                                            <button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="<?= $row['id'] ?>" data-status="<?= $row['status_eqpsite'] ?>">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form id="statusForm" method="post" action="sdg-pk/eqpsite-process.php"  enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="statusSelect">Status EQP On Site</label>
