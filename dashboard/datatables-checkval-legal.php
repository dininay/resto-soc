...
$sql = "SELECT d.*, r.lamp_vl, l.lamp_land, r.status_approvowner, r.status_approvnego, l.nama_lahan, l.lokasi
        FROM re r
...
$sla_query = "SELECT sla FROM master_sla WHERE divisi = 'VD'";
...
if ($sla_result->num_rows > 0) {
    ...
    echo "No SLA value found for 'VD'";
}
                                ...
                                <table class="display table table-striped table-bordered" id="zero_configuration_table" style="width:100%">
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <?php
                                                // Bagian ini di dalam loop yang menampilkan data tabel
                                                $lamp_vdsign_files = explode(",", $row['lamp_vdsign']); // Pisahkan nama file menjadi array
                                                // Periksa apakah array tidak kosong sebelum menampilkan ikon
                                                if (!empty($row['lamp_vdsign'])) {
                                                    echo '<td>
                                                            <ul style="list-style-type: none; padding: 0; margin: 0;">';
                                                    // Loop untuk setiap file dalam array
                                                    foreach ($lamp_vdsign_files as $kom) {
                                                        echo '<li style="display: inline-block; margin-right: 5px;">
                                                                <a href="uploads/' . $kom . '" target="_blank">
                                                                    <i class="fas fa-file-pdf nav-icon"></i>
                                                                </a>
                                                ...
                                                ?>       
                                                <td><?= $row['catatan_vd'] ?></td>
                                                <td>
                                                    <?php
                                                    // Mengatur timezone ke Asia/Jakarta (sesuaikan dengan timezone lokal Anda)
                                                    date_default_timezone_set('Asia/Jakarta');

                                                    $start_date = $row['vdlegal_date'];
                                                    $sla_date = $row['slavd_date'];
                                                    $status_approvlegalvd = $row['status_approvlegalvd'];
                                                ...
                                                <td>
                                                    ...
                                                    if ($row['status_approvlegalvd'] != "Approve") {
                                                        echo '<button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="'. $row['id'] .'" data-status="'. $row['status_approvlegalvd'] .'">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="legal/checkval-process.php" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status Approve VD<strong><span style="color: red;">*</span></strong></label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="lamp_vdsign">Upload File VD<strong><span style="color: red;">*</span></strong></label>
                                                                            <input type="file" class="form-control" id="lamp_vdsign" name="lamp_vdsign[]" multiple>
                                                                        </div>
