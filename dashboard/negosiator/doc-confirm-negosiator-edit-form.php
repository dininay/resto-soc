...
$options = "";
if ($status_approvnego == "In Process") {
    $options = "<option value='Pending'>Pending</option><option value='Approve'>Approve</option>";
} elseif ($status_approvnego == "Pending") {
    $options = "<option value='In Process'>In Process</option><option value='Approve'>Approve</option>";
} else {
		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Doc Confirm Negosiator</h1>
                    <ul>
                        <li><a href="href">Edit</a></li>
                        <li>Doc Confirm Negosiator</li>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-5">
                            <div class="card-body">
                            <form method="post" action="doc-confirm-negosiator-edit.php" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="status_approvnego">Status Approval Negosiator</label>
                                    <div class="col-sm-10">
                                        <select class="form-control" id="status_approvnego" name="status_approvnego">
                                            <?php echo $options; ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="catatan">Catatan Negosiator</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="catatan" name="catatan_nego" rows="4" cols="50"><?php echo $row['catatan_nego']; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-10">
