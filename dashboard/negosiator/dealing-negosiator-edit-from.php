...
if(isset($_GET['id'])) {
    ...
    $result = $conn->query("SELECT * FROM negosiator WHERE id = '$id'");
		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Dealing Draft Negosiator</h1>
                    <ul>
                        <li><a href="href">Edit</a></li>
                        <li>Dealing Draft Negosiator</li>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="card mb-5">
                            <div class="card-body">
                            <form method="post" action="dealing-negosiator-edit.php" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                            <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="confirm_nego">Confirm Negosiator</label>
                                    <div class="col-sm-10">
                                        <select class="form-control" id="confirm_nego" name="confirm_nego">
                                            <?php echo $options; ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" id="jadwal_psm" name="jadwal_psm" type="date" placeholder="Penjadwalan PSM" value="<?php echo $row['jadwal_psm']; ?>"/>
                                    </div>
                                </div>
