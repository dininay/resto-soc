...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT crew3.*, socdate_academy.sla_kpt3 FROM crew3 INNER JOIN socdate_academy ON socdate_academy.kode_lahan = crew3.kode_lahan WHERE crew3.kode_lahan = ? AND status_lolos = 'Siap Training'";
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="academy/datacrewkpt3a-process.php" enctype="multipart/form-data">
                                                ...
                                                <div class="modal fade" id="editModal2" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="academy/datacrewkpt3b-process.php" enctype="multipart/form-data">
