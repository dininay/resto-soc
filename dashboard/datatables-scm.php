                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $start_date = $row['sj_date'];
                                                    $sla_date = $row['sla_scm'];
                                                    $status_scm = $row['status_scm'];
                                                ...
                                                <td>
                                                    ...
                                                    if ($row['status_scm'] != "Done" && $current_time >= $work_start && $current_time <= $work_end) {
                                                        ...
                                                        echo '<a href="datatables-data-scmutensil.php?id='. $row['kode_lahan'].'" class="btn btn-sm btn-info">
