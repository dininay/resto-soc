                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $slaLegalDate = new DateTime($row['sla_spkwofa']);
                                                    
                                                    // Mendapatkan tanggal hari ini
                                                    $today = new DateTime();
                                                    
                                                    // Menghitung selisih hari antara sla_spkwofa dan hari ini
                                                    $diff = $today->diff($slaLegalDate);
                                                    
                                                    // Menghitung scoring
                                                    $scoring = calculateScoring($row['sdgsumber_date'], $row['sla_spkwofa'], $sla_value); // Make sure $sla_value is set correctly
                                                    $remarks = getRemarks($scoring);

                                                    if ($row['status_procurspkwofa'] == "Done") {
                                                ...
                                                <?php if ($row['status_procurspkwofa'] != "Done"): ?>
                                                        ...
                                                        <button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="<?= $row['id'] ?>" data-status="<?= $row['status_procurspkwofa'] ?>">
