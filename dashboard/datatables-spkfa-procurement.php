                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="badge rounded-pill badge-<?php echo $badge_color; ?>">
                                                        <?php echo $row['status_procurspkwofa']; ?>
                                                    </span>
                                                </td>
                                                <td>
                                                    <?php
                                                    ...
                                                    $start_date = $row['spkwofa_date'];
                                                    $sla_date = $row['sla_spkwofa'];
                                                    $status_procurspkwofa = $row['status_procurspkwofa'];
                                                ...
                                                <td>
                                                    ...
                                                    if ($row['status_procurspkwofa'] != "Approve" && $current_time >= $work_start && $current_time <= $work_end) {
                                                        echo '<a href="procurement/spkfa-procur-edit-form.php?id='. $row['id'] .'" class="btn btn-sm btn-warning mr-2">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a>';
                                                        echo '<button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="'. $row['id'] .'" data-status="'.$row['status_procurspkwofa'] .'">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="procurement/spkfa-procur-process.php" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" id="statusSelect" name="status_procurspkwofa" Placeholder="Pilih">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="catatan_spkwofa">Catatan SPK Filter Air</label>
                                                                        <input type="text" class="form-control" id="catatan_spkwofa" name="catatan_spkwofa">
                                                                    </div>
