...
$sla_query = "SELECT sla FROM master_sla WHERE divisi = 'LOA-CD'";
...
if ($sla_result->num_rows > 0) {
    ...
    echo "No SLA value found for 'LOA-CD'";
}
		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Datatables LOA (Letter Of Agreement) & CD (Collection Data)</h1>
                </div>
                        ...
                        <div class="card text-left">
                            <div class="card-body">
								...
								<div class="footer-bottom float-right">
									<!-- <p><a class="btn btn-primary btn-icon m-1" href="re/loa-cd-from.php">+ add LOA | CD </a></p> -->
									<p>
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $sla_date = $row['slaloa_date'];
                                                    $status_approvloacd = $row['status_approvloacd'];
                                                ...
                                                <td>
                                                    ...
                                                    if ($current_time >= $work_start && $current_time <= $work_end) {
                                                        echo '<a href="re/loa-cd-edit-form.php?id='. $row['id'] .'" class="btn btn-sm btn-warning mr-2">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a>';
                                                        echo '<button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="' . $row['id'] .'" data-status="' . $row['status_approvloacd'] .'">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="re/loa-cd-process.php" enctype="multipart/form-data">
                                                                    <input type="hidden" name="id" value="<?=$row["id"]?>"  id="modalKodeLahan">
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status Approve LOA CD<strong><span style="color: red;">*</span></strong></label>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form method="POST" action="loa-cd-delete.php">
...
<?php if ($status_approvloacd == 'Pending') { ?>
    <script>
        $(document).ready(function () {
