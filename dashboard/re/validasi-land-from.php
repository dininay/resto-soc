...
// Query untuk mengambil semua kode lahan yang sudah disetujui dan status_approvlegal = 'Approve'
$result = $conn->query("SELECT DISTINCT kode_lahan FROM re WHERE status_approvowner = 'Approve' AND status_approvlegal != 'In Process'");
    ...
    <script>
        $(document).ready(function() {
            $('#kode_lokasi').change(function() {
                ...
                $.ajax({
                    url: 'validasi-land-get.php', // Gunakan file yang sama sebagai URL
                    type: 'post',
            ...
            <div class="main-content">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-5">
                            <div class="card-body">
                            <form method="post" action="validasi-land-process.php" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" id="start_date" name="start_date" type="text" placeholder="Start Date" readonly/>
                                    </div>
                                </div>
                                <div class="form-group row">
