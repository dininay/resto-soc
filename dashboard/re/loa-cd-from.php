...
// Query untuk mengambil semua kode lahan yang sudah ada dalam tabel dokumen_loacd
$result_existing = $conn->query("SELECT DISTINCT kode_lahan FROM dokumen_loacd");
...
$result = $conn->query("SELECT DISTINCT kode_lahan FROM re WHERE status_approvowner = 'Approve' AND status_approvlegal = 'Approve' and status_approvnego = 'Approve'");
    ...
    <script>
        $(document).ready(function() {
            $('#kode_lokasi').change(function() {
                ...
                $.ajax({
                    url: 'loa-cd-get.php', // Gunakan file yang sama sebagai URL
                    type: 'post',
                    data: {kode_lahan: kode_lahan},
                    dataType: 'json',
                    success: function(response) {
                        $('#status_approvowner').val(response.status_approvowner);
                        $('#status_approvlegal').val(response.status_approvlegal);
                        $('#status_approvnego').val(response.status_approvnego);
            ...
            <div class="main-content">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-5">
                            <div class="card-body">
                            <form method="post" action="loa-cd-process.php" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="status_approvowner">Approval Owner</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" id="status_approvowner" name="status_approvowner" type="text" placeholder="Approval Owner" readonly/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="status_approvlegal">Approval Legal</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" id="status_approvlegal" name="status_approvlegal" type="text" placeholder="Approval Legal" readonly/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="status_approvnego">Approval Negosiator</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" id="status_approvnego" name="status_approvnego" type="text" placeholder="Approval Negosiator" readonly/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="tgl_berlaku">Tgl Berlaku</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" id="tgl_berlaku" name="tgl_berlaku" type="date" placeholder="Tgl Berlaku" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="penanggungjawab">Penanggungjawab</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" id="penanggungjawab" name="penanggungjawab" type="text" placeholder="Penanggungjawab" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="catatan">Catatan</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" id="catatan" name="catatan" type="text" placeholder="Catatan" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="lamp_loacd">Upload LOA & CD</label>
                                    <div class="col-sm-10">
