...
if(isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $status_land = $row['status_land'];
    } else {
        echo "Data tidak ditemukan.";
    }
}
$options = "";
if ($status_land == "On Planning") {
    $options = "<option value='Reject'>Reject</option><option value='Aktif'>Aktif</option>";
} elseif ($status_land == "Reject") {
		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Bussiness Planning</h1>
                    <ul>
                        <li><a href="href">Edit</a></li>
                        <li>Bussiness Planning</li>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-5">
                            <div class="card-body">
                            <form method="post" action="bussiness-plan-edit.php" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="status_land">Status Lahan</label>
                                    <div class="col-sm-10">
                                        <select class="form-control" id="status_land" name="status_land">
                                            <?php echo $options; ?>
                                        </select>
                                    </div>
                                </div>
