		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Validasi Data To Legal</h1>
                    <ul>
                        <li><a href="href">Detail</a></li>
                        <li>Validasi Data To Legal</li>
                    </ul>
                </div>
                        ...
                        <div class="card mb-5">
                            ...
                            <form >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label" for="status_approvnego">Approval Negosiator</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo $row['status_approvnego']; ?></p>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label" for="tgl_berlaku">Tanggal Berlaku</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo $row['tgl_berlaku']; ?></p>
                                        </div>
                                    </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label" for="penanggungjawab">Penanggungjawab</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo $row['penanggungjawab']; ?></p>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo $row['catatan']; ?></p>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="col-md-6">
                                    <div class="form-group row">
                                    <label class="col-sm-4 col-form-label" for="lamp_loacd">Lampiran Loa CD</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static">
                                                <?php 
                                                $lamp_land_files = explode(",", $row['lamp_loacd']); // Pisahkan nama file menjadi array
                                                foreach ($lamp_land_files as $file): ?>
                                                    <a href="../uploads/<?php echo $file; ?>" target="_blank">
                                                        <i class="bi bi-file-earmark"></i>
                                                    </a>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-10">
                                    <a href="/Resto/dashboard/datatables-validasi-data.php" class="btn btn-primary">Kembali</a>
