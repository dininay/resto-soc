...
if(isset($_GET['id'])) {
    ...
    $result = $conn->query("SELECT * FROM re WHERE id = '$id'");
		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Validasi Lahan To Legal</h1>
                    <ul>
                        <li><a href="href">Detail</a></li>
                        <li>Validasi Lahan To Legal</li>
                    </ul>
                </div>
                        ...
                        <div class="card mb-5">
                            ...
                            <form >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label" for="nama_lokasi">Nama Lahan</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo $row['nama_lahan']; ?></p>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label" for="lokasi">Lokasi</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label" for="luas_area">Luas Area</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo $row['luas_area']; ?></p>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label" for="status_approvowner">Approval Owner</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo $row['status_approvowner']; ?></p>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label" for="catatan_owner">Catatan Owner</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo $row['catatan_owner']; ?></p>
                                        </div>
                                    </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label" for="status_approvlegal">Approval Legal</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo $row['status_approvlegal']; ?></p>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label" for="catatan_legal">Catatan Legal</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo $row['catatan_legal']; ?></p>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label" for="lamp_land">Lampiran Lahan</label>
                                        <div class="col-sm-8">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-10">
                                    <a href="/Resto/dashboard/datatables-validasi-lahan.php" class="btn btn-primary">Kembali</a>
                                        <!-- <button class="btn btn-warning" onclick="printPDF()">Print PDF</button> -->
                                    </div>
                                </div>
                    </div>
                </div>
