...
if(isset($_GET['id'])) {
    ...
    $result = $conn->query("SELECT r.id, r.kode_lahan, r.nama_store, l.kode_lahan, l.nama_lahan FROM resto r 
    INNER JOIN land l ON l.kode_lahan = r.kode_lahan WHERE r.id = '$id'");
                    ...
                    <div class="col-md-6">
                        <div class="card mb-5">
                            ...
                            <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="nama_lokasi">Nama Lahan Lama</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" id="nama_lokasi" name="nama_lahan" type="text" value="<?php echo $row['nama_lahan']; ?>" placeholder="Nama Lama" readonly/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="nama_lokasi">Nama Resto Baru</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" id="nama_lokasi" name="nama_lahan" type="text" value="<?php echo $row['nama_lahan']; ?>" placeholder="Nama Store" />
                                    </div>
                                </div>
