...
if(isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $status_approvre = $row['status_approvre'];
    $kode_lahan = $row['kode_lahan'];
    $nama_lahan = $row['nama_lahan'];
    $lokasi = $row['lokasi'];
    $luas_area = $row['luas_area'];
    $lamp_land = $row['lamp_land'];
    } else {
        echo "Data tidak ditemukan.";
    }
}
$options = "";
if ($status_approvre == "In Process") {
		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Submit to Owner</h1>
                    <ul>
                        <li><a href="href">Edit</a></li>
                        <li>Submit to Owner</li>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-5">
                            <div class="card-body">
                            <form method="post" action="submit-owner-edit.php" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo $id; ?>">
                            <input type="hidden" name="kode_lahan" value="<?php echo $kode_lahan; ?>">
                            <input type="hidden" name="nama_lahan" value="<?php echo $nama_lahan; ?>">
                            <input type="hidden" name="lokasi" value="<?php echo $lokasi; ?>">
                            <input type="hidden" name="luas_area" value="<?php echo $luas_area; ?>">
                            <input type="hidden" name="lamp_land" value="<?php echo $lamp_land; ?>">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="status_approvre">Status Approve RE</label>
                                    <div class="col-sm-10">
                                        <select class="form-control" id="status_approvre" name="status_approvre">
                                            <?php echo $options; ?>
                                        </select>
                                    </div>
                                </div>
