                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if ($row['status_tafpay'] != "Paid" && $current_day >= 1 && $current_day <= 5) {
                                                        ...
                                                        echo '<button class="btn btn-sm btn-primary edit-btn mr-2" data-toggle="modal" data-target="#editModal" data-id="'. $row['id'] .'" data-status="'.$row['status_tafpay'] .'">
