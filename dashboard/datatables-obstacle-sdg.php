...
$sla_query = "SELECT sla FROM master_sla WHERE divisi = 'Layouting'";
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $slaLegalDate = new DateTime($row['sla_layout']);
                                                    ...
                                                    // Menghitung scoring
                                                    $scoring = calculateScoring($row['obs_date'], $row['sla_layout'], $sla_value); // Make sure $sla_value is set correctly
