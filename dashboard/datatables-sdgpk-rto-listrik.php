                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    // Menghitung scoring
                                                    $scoring = calculateScoring($row['sdglistrik_date'], $row['sla_mep'], $sla_value); // Make sure $sla_value is set correctly
                                                ...
                                                <?php if ($row['status_sdglistrik'] != "Done"): ?>
                                                        <a href="sdg-pk/sdgpk-rto-listrik-edit-form.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a>
                                                        <!-- <button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="<?= $row['id'] ?>" data-status="<?= $row['status_sdglistrik'] ?>">
