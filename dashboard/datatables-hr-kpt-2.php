...
$sql = "SELECT socdate_academy.*, socdate_hr.lamp_ff2, dokumen_loacd.kode_store, land.nama_lahan 
...
$sla_query = "SELECT sla FROM master_slacons WHERE divisi = 'kpt2'";
...
if ($sla_result->num_rows > 0) {
    ...
    echo "No SLA value found for 'kpt2'";
}
		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Data Completion Training Rate Batch 2</h1>
                </div>
                                    ...
                                    <table class="display table table-striped table-bordered" id="zero_configuration_table" style="width:100%">
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                ?>
                                                <td><?= $row['crew_needed2'] ?></td>
                                                <td><?= $row['crew_onboardkpt2'] ?></td>
                                                <td><?= intval($row['mortality_kpt2']) ?>%</td>
                                                <td><?= intval($row['comprate_kpt2']) ?>%</td>
                                                <td>
                                                    <?php
                                                        // Tentukan warna badge berdasarkan status approval owner
                                                        $badge_color = '';
                                                        switch ($row['status_kpt2']) {
                                                            case 'Done':
                                                                $badge_color = 'success';
                                                                break;
                                                            case 'Pending':
                                                ...
                                                <td>
                                                    ...
                                                    $start_date = $row['kpt_date2'];
                                                    $sla_date = $row['sla_kpt2'];
                                                    $status_kpt2 = $row['status_kpt2'];
                                                ...
                                                <td>
                                                    ...
                                                    if ($row['status_kpt2'] != "Done" && $current_time >= $work_start && $current_time <= $work_end) {
                                                        echo '<a href="academy/kpt2-edit-form.php?id='. $row['id'] .'" class="btn btn-sm btn-warning mr-2">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a>';
                                                        echo '<button class="btn btn-sm btn-primary edit-btn mr-2" data-toggle="modal" data-target="#editModal" data-id="'. $row['id'] .'" data-status="'.$row['status_kpt2'] .'">
                                                            <i class="nav-icon i-Book"></i>
                                                        </button>';
                                                        echo '<a href="datatables-data-kpt2.php?id='. $row['kode_lahan'].'" class="btn btn-sm btn-info">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="academy/kpt2-process.php" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" id="statusSelect" name="status_kpt2" Placeholder="Pilih">
