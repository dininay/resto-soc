		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Data Ketepatan Periode Training</h1>
                </div>
							  ...
							  <div class="table-responsive">
                                    <table class="display table table-striped table-bordered" id="zero_configuration_table" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>Kode Lahan</th>
                                                <th>Ketepatan Periode Training</th>
                                                <th>Lampiran</th>
                                                <th>Status</th>
                                                <th>SLA</th>
												<th>Action</th>
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                $lamp_kpt2_files = explode(",", $row['lamp_kpt2']); // Pisahkan nama file menjadi array
                                                // Periksa apakah array tidak kosong sebelum menampilkan ikon
                                                if (!empty($row['lamp_kpt2'])) {
                                                    echo '<td>
                                                            <ul style="list-style-type: none; padding: 0; margin: 0;">';
                                                    // Loop untuk setiap file dalam array
                                                    foreach ($lamp_kpt2_files as $kpt2) {
                                                        echo '<li style="display: inline-block; margin-right: 5px;">
                                                                <a href="uploads/' . $kpt2 . '" target="_blank">
                                                ...
                                                <td>
                                                    ...
                                                    $slaDate = new DateTime($row['sla_kpt2']);
                                                ...
                                                <td>
                                                <!-- Tombol Edit -->
                                                <?php if ($row['status_kpt2'] != "Approve"): ?>
                                                        <a href="academy/kpt2-edit-form.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a>
                                                    <?php endif; ?>
                                                    <?php if ($row['status_kpt2'] != "Approve"): ?>
                                                        <button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="<?= $row['id'] ?>" data-status="<?= $row['status_kpt2'] ?>">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="academy/kpt2-process.php" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status Approve KPT 2</label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="catatan_kpt2">Catatan KPT 2</label>
                                                                        <input type="text" class="form-control" id="catatan_kpt2" name="catatan_kpt2">
                                                                    </div>
