		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>List Data Entry SOC to RTO</h1>
                </div>
                        ...
                        <div class="card text-left">
                            <div class="card-body">
								...
								<div class="footer-bottom float-right">
									<p><a class="btn btn-primary btn-icon m-1" href="operation/soc-form.php">+ add SOC </a></p>
									<p>
                                            ...
                                            <tr>
                                                ...
                                                <!-- Tombol Edit -->
                                                        ...
                                                        <form method="post" action="" class="status-form" style="display: none; margin-top: 10px;">
                                                            ...
                                                            <select class="form-control" name="status_land" onchange="this.form.submit()">
                                                                <option value="In Process" <?= $row['status_land'] == 'In Process' ? 'selected' : '' ?>>In Process</option>
                                                                <option value="Pending" <?= $row['status_land'] == 'Pending' ? 'selected' : '' ?>>Pending</option>
                                                                <option value="Approve" <?= $row['status_land'] == 'Approve' ? 'selected' : '' ?>>Approve</option>
                                                            </select>
                                                        </form>
                                                        </div> -->
                                                </td>
