		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>List Data Equipment Delivery</h1>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="badge rounded-pill badge-<?php echo $badge_color; ?>">
                                                        <?php echo $row['status_eqpdev']; ?>
                                                    </span>
                                                </td>
                                                <td>
                                                    <?php
                                                    // Mendapatkan tanggal sla_date dari kolom data
                                                    $slaLegalDate = new DateTime($row['sla_eqpdev']);
                                                    
                                                    // Mendapatkan tanggal hari ini
                                                    $today = new DateTime();
                                                    
                                                    // Menghitung selisih hari antara sla_eqpdev dan hari ini
                                                    $diff = $today->diff($slaLegalDate);
                                                    
                                                    // Menghitung scoring
                                                    $scoring = calculateScoring($row['eqpdev_date'], $row['sla_eqpdev'], $sla_value); // Make sure $sla_value is set correctly
                                                    $remarks = getRemarks($scoring);

                                                    if ($row['status_eqpdev'] == "Done") {
                                                ...
                                                <td>
                                                    ...
                                                    $sla_steqp = new DateTime($row['sla_eqpdev']);
                                                    ...
                                                    if ($row['status_eqpdev'] !== 'Done') : ?>
                                                        <div>
                                                            <a href="sdg-pk/eqpdev-edit-form.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning">
                                                                <i class="i-Pen-2"></i>
                                                            </a>
                                                            <button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="<?= $row['id'] ?>" data-status="<?= $row['status_eqpdev'] ?>">
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form id="statusForm" method="post" action="sdg-pk/eqpdev-process.php"  enctype="multipart/form-data">
                                                                        <input type="hidden" name="id" id="modalId" value="<?= $row['id']; ?>">
                                                                        <div class="form-group">
                                                                            <label for="statusSelect">Status EQP Delivery</label>
...
<script>
    $(document).ready(function() {
        ...
        // Inisialisasi DataTable dengan scroll horizontal dan fixed header
        $('#zero_configuration_table').DataTable({
            scrollX: true, // Menambahkan scroll horizontal
            fixedHeader: true, // Membuat thead fixed saat scroll
            fixedColumns: {
                leftColumns: 3 // Jumlah kolom yang ingin di-fix di sisi kiri
            }
        });
    });
</script>
