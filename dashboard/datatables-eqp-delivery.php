                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $start_date = $row['eqpdev_date'];
                                                    $sla_date = $row['sla_eqpdev'];
                                                    $status_eqpdev = $row['status_eqpdev'];
                                                ...
                                                <td>
                                                    ...
                                                    if ($row['status_eqpdev'] != "Approve") {
                                                        ...
                                                        echo '<button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="'. $row['id'] .'" data-status="'.$row['status_eqpdev'] .'">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form id="statusForm" method="post" action="sdg-pk/eqpdev-process.php"  enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="statusSelect">Status EQP Delivery<strong><span style="color: red;">*</span></strong></label>
