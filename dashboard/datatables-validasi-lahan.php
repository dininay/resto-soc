                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $start_date = $row['vl_date'];
                                                    $sla_date = $row['slavl_date'];
                                                ...
                                                <!-- <td>
                                                    <?php if ($row['status_vl'] != "Approve"): ?>
                                                        <a href="legal/vl-edit-form.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning mr-2">
                                                ...
                                                <td>
                                                    ...
                                                    if ($row['status_vl'] != "Approve") {
                                                        echo '<a href="legal/vl-edit-form.php?id='. $row['id'] . '" class="btn btn-sm btn-warning mb-2">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a>';
                                                    }
                                                    ?>
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="legal/wovl-process.php" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status Approve VL<strong><span style="color: red;">*</span></strong></label>
