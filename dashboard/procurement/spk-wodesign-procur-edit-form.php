...
$sql = "SELECT s.*, l.city, l.kode_lahan
        FROM sdg_desain s
                        ...
                        <div class="card mb-5">
                            ...
                            <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="nominal_spkdesign">Nominal (include PPN)<strong><span style="color: red;">*</span></strong></label>
                                    <div class="col-sm-9">
                                        <input class="form-control" id="nominal_spkdesign" name="nominal_spkdesign" type="text" oninput="formatRupiah(this)" placeholder="Masukkan Angka Saja" value="<?php echo $row['nominal_spkdesign']; ?>"/>
                                    </div>
                                </div>
                                <div class="form-group row">
