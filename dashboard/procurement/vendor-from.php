		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>List Data Vendor</h1>
                    <ul>
                        <li><a href="href">Form</a></li>
                        <li>List Data Vendor</li>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-5">
                            <div class="card-body">
                            <form method="post" action="vendor-process.php" enctype="multipart/form-data">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="kode_lokasi">Kota</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" id="nama_vendor" name="nama" type="text" placeholder="Nama Vendor" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="alamat_vendor">Alamat Vendor</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" id="alamat_vendor" name="alamat" type="text" placeholder="Alamat Vendor" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="nohp_vendor">No HP Vendor</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" id="nohp_vendor" name="nohp" type="text" placeholder="No HP Vendor" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="detail_vendor">Detail</label>
                                    <div class="col-sm-9">
                                        <textarea class="form-control" id="detail_vendor" name="detail" rows="4" cols="50"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="lamp_vendor">Upload Lampiran Vendor</label>
                                    <div class="col-sm-9">
                                        <div class="dropzone" id="multple-file-upload" >
