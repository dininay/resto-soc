    ...
    try {
        ...
        if ($stmt_update->execute() === TRUE) {
            ...
            if ($status_spkwoipal == 'Approve') {
                ...
                $status_sdgipal = "Done";
                $sql_update_pending = "UPDATE socdate_sdg SET status_spkwoipal = ?, catatan_spkwoipal = ?, spkwoipal_date = ?, status_sdgipal = ? WHERE id = ?";
                $stmt_update_pending = $conn->prepare($sql_update_pending);
                $stmt_update_pending->bind_param("ssssi", $status_spkwoipal, $catatan_spkwoipal, $spkwoipal_date, $status_sdgipal, $id);
            ...
            foreach ($departments as $department) {
                ...
                if (!empty($toEmails)) {
                    try {
                        ...
                        $mail->Subject = 'Notification: New SPK IPAL Release Resto SOC Ticket';
                        $mail->Body = '
                                        ...
                                        <div style="background-color: #f7f7f7; border-radius: 8px; padding: 0; margin: 0; text-align: center;">
                                            ...
                                            <div style="padding: 20px; background-color: #f7f7f7; border-radius: 8px;">
                                                ...
                                                <p>We would like to inform you that a new SPK IPAL Release Resto SOC Ticket has been created. This needs your attention, please log in to the SOC application to review the details at your earliest convenience.
                                    ...
                                    $mail->AltBody = 'Dear '. $department .' Team,'
                                                . 'We would like to inform you that a new SPK IPAL Release Resto SOC Ticket has been created. This needs your attention, please log in to the SOC application to review the details at your earliest convenience.
