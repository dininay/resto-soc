                    ...
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            ...
                            if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
                                ...
                                // Konten email
                                $mail->isHTML(true);
                                $mail->Subject = 'Notification: 1 New Active Done Construction Tender Process Resto SOC Ticket';
                                $mail->Body    = '
                                ...
                                $mail->AltBody = 'Dear Team,'
                                               . 'You have 1 New Active Done Construction Tender Process Resto SOC Ticket in the Resto SOC system. Please log in to the SOC application to review the details.'
