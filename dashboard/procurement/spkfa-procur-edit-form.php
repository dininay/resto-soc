		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>MEP - Filter Air</h1>
                    <ul>
                        <li><a href="href">Edit</a></li>
                        <li>MEP - Filter Air</li>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-5">
                            <div class="card-body">
                            <form method="post" action="spkfa-procur-edit.php" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="nominal_spkfa">Nominal (include PPN)<strong><span style="color: red;">*</span></strong></label>
                                    <div class="col-sm-9">
                                        <input class="form-control" id="nominal_spkfa" name="nominal_spkfa" type="text" oninput="formatRupiah(this)" placeholder="Masukkan Angka Saja" value="<?php echo $row['nominal_spkfa']; ?>"/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="lamp_spkwofilterair">Upload Lampiran SPK Filter Air<strong><span style="color: red;">*</span></strong></label>
                                    <div class="col-sm-9">
                                        <div class="dropzone" id="multiple-file-upload">
                                            <input name="lamp_spkwofilterair[]" type="file" multiple="multiple" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
