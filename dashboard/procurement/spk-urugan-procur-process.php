...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["id"])  && isset($_POST["status_procururugan"])&& isset($_POST["catatan_procururugan"])) {
    ...
    try {
        ...
        if ($stmt_update->execute() === TRUE) {
            ...
            if ($status_procururugan == 'Approve') {
                $spkurugan_date = date("Y-m-d");
                ...
                foreach ($departments as $department) {
                    ...
                    if (!empty($toEmails)) {
                        try {
                            ...
                            $mail->Subject = 'Notification: New SPK Urugan Release Resto SOC Ticket';
                            $mail->Body = '
                                        ...
                                        <div style="background-color: #f7f7f7; border-radius: 8px; padding: 0; margin: 0; text-align: center;">
                                            ...
                                            <div style="padding: 20px; background-color: #f7f7f7; border-radius: 8px;">
                                                ...
                                                <p>We would like to inform you that a new SPK Urugan Release Resto SOC Ticket has been created. This needs your attention, please log in to the SOC application to review the details at your earliest convenience.
                                    ...
                                    $mail->AltBody = 'Dear '. $department .' Team,'
                                                . 'We would like to inform you that a new SPK Urugan Release Resto SOC Ticket has been created. This needs your attention, please log in to the SOC application to review the details at your earliest convenience.
