        ...
        if ($status_kondisilahan == 'Done') {
            ...
            $queryIR = "SELECT email FROM user WHERE level IN ('SDG-Project')";
                ...
                if (!empty($toEmails)) {
                    ...
                    // Email content
                    $mail->Subject = 'Notification: 1 New Information Land Has Been Done Land Conditioning by Legal Resto SOC Ticket';
                                        $mail->Body    = '
                                            ...
                                            <div style="background-color: #f7f7f7; border-radius: 8px; padding: 0; margin: 0; text-align: center;">
                                                ...
                                                <div style="padding: 20px; background-color: #f7f7f7; border-radius: 8px;">
                                                    ...
                                                    <p>We would like to inform you that a new Information Land Has Been Done Land Conditioning by Legal Resto SOC Ticket has been created. This needs your attention, please log in to the SOC application to review the details at your earliest convenience.
                                        ...
                                        $mail->AltBody = 'Dear SDG-Project Team,'
                                                    . 'We would like to inform you that a new Information Land Has Been Done Land Conditioning by Legal Resto SOC Ticket has been created. This needs your attention, please log in to the SOC application to review the details at your earliest convenience.
            ...
            $conn->commit();
            echo "Status berhasil diperbarui.";
        } elseif ($status_kondisilahan == 'Pending') {
                ...
                // Query untuk memperbarui status_kondisilahan, vl_date di tabel re dan memasukkan data ke dalam tabel hold_project
                $sql_update_re = "UPDATE draft SET status_kondisilahan = ?, catatan_kondisilahan = ?, kondisilahan_date = ? WHERE id = ?";
                $stmt_update_re = $conn->prepare($sql_update_re);
                $stmt_update_re->bind_param("sssi", $status_kondisilahan, $catatan_kondisilahan, $kondisilahan_date, $id);
            ...
            } elseif ($status_kondisilahan == 'Reject') {
