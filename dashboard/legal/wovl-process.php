    ...
    try {
        ...
        if ($status_vl == 'Approve') {
            ...
            try {
                ...
                $sql = "SELECT email FROM user WHERE level IN ('Real Estate')";
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        ...
                        // Konten email
                        $mail->isHTML(true);
                        $mail->Subject = 'Notification: 1 New VL Resto SOC Ticket Approved by Legal';
                        $mail->Body    = '
                        <div style="font-family: Arial, sans-serif; font-size: 14px; color: #333;">
                            <div style="background-color: #f7f7f7; padding: 20px; border-radius: 8px;">
                                <h2 style="font-size: 20px; color: #5cb85c; margin-bottom: 10px;">Dear Team,</h2>
                                <p>You have 1 New VL Resto SOC Ticket Approved by Legal in the Resto SOC system. Please log in to the SOC application to review the details.</p>
                        ...
                        $mail->AltBody = 'Dear Team,'
                                       . 'You have 1 New VL Resto SOC Ticket Approved by Legal in the Resto SOC system. Please log in to the SOC application to review the details.'
            ...
            try {
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        ...
                        // Konten email
                        $mail->isHTML(true);
                        $mail->Subject = 'Notification: 1 New Active VL Resto SOC Ticket Requires Revision';
                        $mail->Body    = '
                        <div style="font-family: Arial, sans-serif; font-size: 14px; color: #333;">
                            <div style="background-color: #f7f7f7; padding: 20px; border-radius: 8px;">
                                <h2 style="font-size: 20px; color: #5cb85c; margin-bottom: 10px;">Dear Team,</h2>
                                <p>You have 1 New Active VL Resto SOC Ticket Requires Revision in the Resto SOC system. Please log in to the SOC application to review the details.</p>
                                <p>Thank you for your prompt attention to this matter.</p>
                                <p></p>
                                <p>Best regards,</p>
                                <p>Resto - SOC</p>
                        ...
                        $mail->AltBody = 'Dear Team,'
                                       . 'You have 1 New Active VL Resto SOC Ticket Requires Revision in the Resto SOC system. Please log in to the SOC application to review the details.'
                                       . 'Thank you for your prompt attention to this matter.'
                                       . 'Best regards,'
                                       . 'Resto - SOC';
