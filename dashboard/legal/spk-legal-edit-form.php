		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>SPK Legal from Procurement</h1>
                    <ul>
                        <li><a href="href">Edit</a></li>
                        <li>SPK Legal from Procurement</li>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-5">
                            <div class="card-body">
                            <form method="post" action="spk-legal-edit.php" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                
                            <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="lamp_legalizin">Upload Lampiran Perizinan</label>
                                    <div class="col-sm-9">
                                        <div class="dropzone" id="multple-file-upload" >
                                            <input name="lamp_legalizin[]" type="file" multiple="multiple" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
