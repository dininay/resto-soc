...
$options = "";
if ($status_obslegal == "In Process") {
    $options = "<option value='Pending'>Pending</option><option value='Done'>Done</option>";
} elseif ($status_obslegal == "Pending") {
    $options = "<option value='In Process'>In Process</option><option value='Done'>Done</option>";
} else {
    // Default jika status tidak sesuai
    $options = "<option value=''>Pilih</option><option value='In Process'>In Process</option><option value='Done'>Done</option><option value='Pending'>Pending</option>";
}
		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Obstacle from SDG Design</h1>
                    <ul>
                        <li><a href="href">Edit</a></li>
                        <li>Obstacle from SDG Design</li>
                    </ul>
                </div>
