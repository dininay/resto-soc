		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Surat Pernyataan Submit Legal</h1>
                    <ul>
                        <li><a href="href">Edit</a></li>
                        <li>Surat Pernyataan Submit Legal</li>
                    </ul>
                </div>
                        ...
                        <div class="card mb-5">
                            ...
                            <form method="post" action="submit-legal-edit.php" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="lamp_pbg">Upload Lampiran PBG<strong><span style="color: red;">*</span></strong></label>
                                    <div class="col-sm-9">
                                        <div class="dropzone" id="multple-file-upload" >
                                            <input name="lamp_pbg[]" type="file" multiple="multiple" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="lamp_permit">Upload Lampiran Permit Lain-Lain</label>
                                    <div class="col-sm-9">
                                        <div class="dropzone" id="multple-file-upload" >
                                            <input name="lamp_permit[]" type="file" multiple="multiple" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
