...
if(isset($_GET['id'])) {
    ...
    $result = $conn->query("SELECT * FROM socdate_legal WHERE id = '$id'");
		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Mou Parkir Sampah</h1>
                    <ul>
                        <li><a href="href">Edit</a></li>
                        <li>Mou Parkir Sampah</li>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-5">
                            <div class="card-body">
                            <form method="post" action="mouparkir-edit.php" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="mou_parkirsampah">Upload Lampiran MOU Parkir & Sampah</label>
                                    <div class="col-sm-9">
                                        <div class="dropzone" id="multple-file-upload" >
                                            <input name="mou_parkirsampah[]" type="file" multiple="multiple" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
