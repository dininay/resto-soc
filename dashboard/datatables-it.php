		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Data POS Printer, CCTV, Sound, Internet</h1>
                </div>
                        ...
                        <div class="card text-left">
                            <div class="card-body">
								...
								<div class="footer-bottom float-right">
									<!-- <p><a class="btn btn-primary btn-icon m-1" href="it/it-from.php">+ add Data </a></p> -->
									<p>
                                    ...
                                    <table class="display table table-striped table-bordered" id="zero_configuration_table" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Nama Lahan</th>
                                                <th>Kode Store</th>
                                                <th>Lampiran CCTV & Sound</th>
                                                <th>Lampiran Internet Kasir & Customer</th>
                                                <th>Catatan IT</th>
                                                <th>Status</th>
                                                <th>SLA</th>
												<th>Action</th>
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                $lamp_cctv_files = explode(",", $row['lamp_cctv']); // Pisahkan nama file menjadi array
                                                // Periksa apakah array tidak kosong sebelum menampilkan ikon
                                                if (!empty($row['lamp_cctv'])) {
                                                    echo '<td>
                                                            <ul style="list-style-type: none; padding: 0; margin: 0;">';
                                                    // Loop untuk setiap file dalam array
                                                    foreach ($lamp_cctv_files as $cctv) {
                                                        echo '<li style="display: inline-block; margin-right: 5px;">
                                                                <a href="../uploads/' . $cctv . '" target="_blank">
                                                ...
                                                <?php
                                                // Bagian ini di dalam loop yang menampilkan data tabel
                                                $lamp_internet_files = explode(",", $row['lamp_internet']); // Pisahkan nama file menjadi array
                                                // Periksa apakah array tidak kosong sebelum menampilkan ikon
                                                if (!empty($row['lamp_internet'])) {
                                                    echo '<td>
                                                            <ul style="list-style-type: none; padding: 0; margin: 0;">';
                                                    // Loop untuk setiap file dalam array
                                                    foreach ($lamp_internet_files as $internet) {
                                                        echo '<li style="display: inline-block; margin-right: 5px;">
                                                                <a href="../uploads/' . $internet . '" target="_blank">
                                                                    <i class="fas fa-file-pdf nav-icon"></i>
                                                                </a>
                                                            </li>';
                                                    }
                                                ...
                                                ?>
                                                <td><?= $row['catatan_it'] ?></td>
                                                <td>
                                                    <?php
                                                        // Tentukan warna badge berdasarkan status approval owner
                                                        $badge_color = '';
                                                        switch ($row['status_it']) {
                                                            case 'Done':
                                                                $badge_color = 'success';
                                                                break;
                                                            case 'Pending':
                                                ...
                                                <td>
                                                    ...
                                                    $start_date = $row['it_date'];
                                                    $sla_date = $row['sla_it'];
                                                    $status_it = $row['status_it'];
                                                ...
                                                <td>
                                                    ...
                                                    if ($row['status_it'] != "Done" && $current_time >= $work_start && $current_time <= $work_end) {
                                                        echo '<a href="it/it-edit-form.php?id='. $row['id'] .'" class="btn btn-sm btn-warning mr-2">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a>';
                                                        echo '<button class="btn btn-sm btn-primary edit-btn mr-2" data-toggle="modal" data-target="#editModal" data-id="'. $row['id'] .'" data-status="'.$row['status_it'] .'">
