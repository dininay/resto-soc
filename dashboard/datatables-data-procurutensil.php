...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * from utensil WHERE kode_lahan = ? AND status_utensil = 'Pending In Procurement' OR eta_by = 'Last Updated by Procurement'";
                                    ...
                                    <table class="display table table-striped table-bordered" id="zero_configuration_table" style="width:100%">
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                $date = !empty($row['eta_date']) ? new DateTime($row['eta_date']) : null;
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="procurement/dataprocur-process.php" enctype="multipart/form-data">
                                                                    <input type="hidden" name="id" value=<?= $row['id'] ?> id="modalKodeLahan">
                                                                    <div class="form-group">
                                                                        <label for="eta_date">ETA Date<strong><span style="color: red;">*</strong></label>
