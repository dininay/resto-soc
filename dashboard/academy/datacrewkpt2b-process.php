                ...
                $mail->Subject = 'Notification: 1 New Information Crew FF 2 Resto SOC Ticket';
                                ...
                                <div style="font-family: Arial, sans-serif; font-size: 14px; color: #333;">
                                    <div style="background-color: #f7f7f7; padding: 20px; border-radius: 8px;">
                                        ...
                                        <p>You have 1 New Information Crew FF 2 Resto SOC Ticket in the Resto SOC system. Please log in to the SOC application to review the details.</p>
                                ...
                                $mail->AltBody = 'Dear Team,'
                                            . 'You have 1 New Information Crew FF 2 Resto SOC Ticket in the Resto SOC system. Please log in to the SOC application to review the details.'
