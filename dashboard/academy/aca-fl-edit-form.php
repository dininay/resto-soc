            ...
            <div class="main-content">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-5">
                            <div class="card-body">
                            <form method="post" action="aca-fl-edit.php" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="crew_neededflaca">Crew Needed<strong><span style="color: red;">*</span></strong></label>
                                    <div class="col-sm-9">
                                        <input class="form-control" id="crew_neededflaca" name="crew_neededflaca" type="text" placeholder="Crew Needed FL" value="<?php echo $row['crew_neededflaca']; ?>"/>
                                    </div>
                                </div>
                                <!-- <div class="form-group row">
