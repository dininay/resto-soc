...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $id = $_POST['id'];
    $crew_neededtmaca = $_POST['crew_neededtmaca'];
    // $crew_act1 = $_POST['crew_act1'];
    // $kpt_1 = "";
    // // if ($crew_neededtmaca > 0) {
    // //     $kpt_1 = round(($crew_act1 / $crew_neededtmaca) * 100);
    // // } else {
    // //     $kpt_1 = 0;
    // // }
    // // $lamp_kpt1 = "";
    ...
    $sql = "UPDATE socdate_hraca SET crew_neededtmaca = '$crew_neededtmaca' WHERE id = '$id'";
    if ($conn->query($sql) === TRUE) {
        header("Location: " . $base_url . "/datatables-aca-qs.php");
        exit();
    } else {
