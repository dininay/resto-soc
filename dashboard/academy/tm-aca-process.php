...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["id"]) && isset($_POST["status_tmaca"]) && isset($_POST["catatan_tmaca"]) ) {
    $id = $_POST["id"];
    $status_tmaca = $_POST["status_tmaca"];
    $catatan_tmaca = $_POST["catatan_tmaca"];
    $tmaca_date = null;
    ...
    try {
        ...
        if ($status_tmaca == 'Done') {
            $tmaca_date = date("Y-m-d H:i:s");

            // Query untuk memperbarui status status_tmaca di tabel draft
            $sql_update = "UPDATE socdate_hraca SET status_tmaca = ?, tmaca_date = ?, catatan_tmaca = ? WHERE id = ?";
            $stmt_update = $conn->prepare($sql_update);
            $stmt_update->bind_param("sssi", $status_tmaca, $tmaca_date, $catatan_tmaca, $id);
            $stmt_update->execute();
            ...
            $sql_get_kode_lahan = "SELECT kode_lahan FROM socdate_hraca WHERE id = ?";
            ...
            echo "Status berhasil diperbarui.";
                ...
                // Query untuk memperbarui status_tmaca, vl_date di tabel re dan memasukkan data ke dalam tabel hold_project
                $sql_update_re = "UPDATE socdate_hraca SET status_tmaca = ?, tmaca_date = ?, catatan_tmaca = ? WHERE id = ?";
                $stmt_update_re = $conn->prepare($sql_update_re);
                $stmt_update_re->bind_param("sssi", $status_tmaca, $tmaca_date, $catatan_tmaca, $id);
                ...
                $sql = "UPDATE socdate_hraca SET status_tmaca = ?, tmaca_date = ?, catatan_tmaca = ? WHERE id = ?";
                $stmt = $conn->prepare($sql);
                $stmt->bind_param("sssi", $status_tmaca, $tmaca_date, $catatan_tmaca, $id);
                $stmt->execute();
        ...
        header("Location: ../datatables-aca-qs.php");
