                ...
                $mail->Subject = 'Notification: 1 New Information Crew FF 1 Resto SOC Ticket';
                                ...
                                <div style="font-family: Arial, sans-serif; font-size: 14px; color: #333;">
                                    <div style="background-color: #f7f7f7; padding: 20px; border-radius: 8px;">
                                        ...
                                        <p>We would like to inform you that a new Active Resto SOC Ticket has been created in the Fulfillment 1 Process. This needs your attention, please log in to the SOC application to review the details at your earliest convenience.
Your prompt attention to this matter is greatly appreciated.</p>
                                ...
                                $mail->AltBody = 'Dear HR Team,'
                                            . 'We would like to inform you that a new Active Resto SOC Ticket has been created in the Fulfillment 1 Process. This needs your attention, please log in to the SOC application to review the details at your earliest convenience.
