...
if(isset($_GET['id'])) {
    ...
    $result = $conn->query("SELECT * FROM socdate_hraca WHERE id = '$id'");
            ...
            <div class="main-content">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-5">
                            <div class="card-body">
                            <form method="post" action="aca-tm-edit.php" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="crew_neededtmaca">Crew Needed<strong><span style="color: red;">*</span></strong></label>
                                    <div class="col-sm-9">
                                        <input class="form-control" id="crew_neededtmaca" name="crew_neededtmaca" type="text" placeholder="Crew Needed QC" value="<?php echo $row['crew_neededtmaca']; ?>"/>
                                    </div>
                                </div>
                                <!-- <div class="form-group row">
