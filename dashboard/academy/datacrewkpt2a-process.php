...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["id"]) && isset($_POST["score_oje"]) && isset($_POST["status_oje"]) ) {
    ...
    try {
        if ($status_oje == 'Lolos' || $status_oje == 'Tidak Lolos') {
            ...
            $sql_update = "UPDATE crew2 SET status_oje = ?, oje_date = ?, status_last = ?, score_oje = ? WHERE id = ?";
...
Your prompt attention to this matter is greatly appreciated.'
            ...
            if ($kode_lahan) {
                $sql_update_re = "UPDATE crew2 SET status_oje = ?, oje_date = ? WHERE id = ?";
            ...
            $sql = "UPDATE crew2 SET status_oje = ?, oje_date = ? WHERE id = ?";
