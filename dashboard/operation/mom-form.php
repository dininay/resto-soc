            ...
            <div class="main-content">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-5">
                            <div class="card-body">
                            <form method="post" action="mom-process.php" enctype="multipart/form-data">
                                <div class="form-group row">
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="notes">Notes</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" id="notes" name="notes" type="text" placeholder="Notes" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="updated_by">Updated By</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" id="updated_by" name="updated_by" type="text" placeholder="Updated By" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" id="status" name="status">
                                            ...
                                            <option value="New" <?php echo (isset($row['status']) && $row['status'] == 'New') ? 'selected' : ''; ?>>New</option>
                                            <option value="Urgent" <?php echo (isset($row['status']) && $row['status'] == 'Urgent') ? 'selected' : ''; ?>>Urgent</option>
                                            <option value="Standard" <?php echo (isset($row['status']) && $row['status'] == 'Standard') ? 'selected' : ''; ?>>Standard</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="file">Upload Lampiran</label>
                                    <div class="col-sm-9">
