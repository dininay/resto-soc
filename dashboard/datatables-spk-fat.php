...
$sql = "SELECT l.kode_lahan, l.nama_lahan, l.lokasi, l.lamp_land, d.lamp_draf, c.lamp_loacd, p.status_approvprocurement, 
        ...
        c.lamp_vd, q.lamp_rab, c.status_approvlegalvd, s.lamp_pbg, s.lamp_permit, s.submit_legal, p.alamat,
        sd.lamp_spkwofilterair, sd.lamp_spkwoipal, s.lamp_spkwo, e.lamp_spkeqpdev
        FROM draft d
        ...
        LEFT JOIN sdg_rab q ON r.kode_lahan = q.kode_lahan
        LEFT JOIN socdate_sdg sd ON r.kode_lahan = sd.kode_lahan
        LEFT JOIN equipment e ON r.kode_lahan = e.kode_lahan
		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>List Data SPK & Validation Data from Legal</h1>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                if (!empty($row['lamp_spkeqpdev'])) {
                                                    echo '<td>
                                                            <ul style="list-style-type: none; padding: 0; margin: 0;">';
                                                    // Loop untuk setiap file dalam array
                                                    foreach ($lamp_spkeqpdev_files as $splegal) {
                                                        echo '<li style="display: inline-block; margin-right: 5px;">
                                                                <a href="uploads/' . $splegal . '" target="_blank">
                                                                    <i class="fas fa-file-pdf nav-icon"></i>
                                                                </a>
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="procurement/spk-process.php" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status Approve SPK<strong><span style="color: red;">*</span></strong></label>
