...
WHERE socdate_sdg.status_spkwoipal IN ('Approve', 'In Review By TAF', 'Pending')";
		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Data Review SPK MEP - IPAL</h1>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                        ...
                                                        $badge_color = '';
                                                        switch ($row['status_spkwoipaltaf']) {
                                                            case 'Approve':
                                                                $badge_color = 'success';
                                                                break;
                                                            case 'Pending':
                                                    ...
                                                    <span class="badge rounded-pill badge-<?php echo $badge_color; ?>">
                                                        <?php echo $row['status_spkwoipaltaf']; ?>
                                                    </span>
                                                </td>
                                                <td>
                                                    <?php
                                                    // Mendapatkan tanggal sla_date dari kolom data
                                                    $slaLegalDate = new DateTime($row['sla_spkwoipaltaf']);
                                                    ...
                                                    if ($today->format('N') == 6 || $today->format('N') == 7) { // N = 6 is Saturday, N = 7 is Sunday
                                                        ...
                                                        // Menghitung scoring
                                                        $scoring = calculateScoring($row['spkwoipaltaf_date'], $row['sla_spkwoipaltaf'], $sla_value); // Make sure $sla_value is set correctly
                                                        $remarks = getRemarks($scoring);

                                                        if ($row['status_spkwoipaltaf'] == "Approve") {
                                                ...
                                                <?php if ($row['status_spkwoipaltaf'] != "Approve"): ?>
                                                        <!-- <a href="procurement/spkipal-procur-edit-form.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning mr-2">
                                                            <i class="nav-icon i-Pen-2"></i>
                                                        </a> -->
                                                        <button class="btn btn-sm btn-primary edit-btn" data-toggle="modal" data-target="#editModal" data-id="<?= $row['id'] ?>" data-status="<?= $row['status_spkwoipaltaf'] ?>">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="fat/spkipal-fat-process.php" enctype="multipart/form-data">
                                                                    <input type="hidden" name="id" value=<?= $row['id'] ?> id="modalKodeLahan">
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status Approve SPK IPAL<strong><span style="color: red;">*</span></strong></label>
                                                                        <select class="form-control" id="statusSelect" name="status_spkwoipaltaf" Placeholder="Pilih">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="catatan_spkwoipaltaf">Catatan SPK IPAL</label>
                                                                        <input type="text" class="form-control" id="catatan_spkwoipaltaf" name="catatan_spkwoipaltaf">
                                                                    </div>
