                            ...
                            <div class="col-md-12">
                                <div class="card o-hidden mb-4">
                                    <div class="card-header d-flex align-items-center border-0">
                                        <h3 class="w-50 float-left card-title m-0">MoM</h3>
                                            ...
                                            <table class="table text-center" id="user_table">
                                                ...
                                                <?php foreach ($data as $row): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-outline-primary mt-3 mb-3 m-sm-0 btn-sm btn-rounded" onclick="window.location.href='uploads/<?= $row['file'] ?>'">
                                                                View details
                                                            </button>
                                                        </td>
                                                    </tr>
