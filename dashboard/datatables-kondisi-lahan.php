                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                        // Tentukan warna badge berdasarkan status approval owner
                                                        $badge_color = '';
                                                        switch ($row['status_kondisilahan']) {
                                                            case 'Done':
                                                                $badge_color = 'success';
                                                                break;
                                                            case 'Pending':
                                                    ...
                                                    ?>
                                                    <span class="badge rounded-pill badge-<?php echo $badge_color; ?>">
                                                        <?php echo $row['status_kondisilahan']; ?>
                                                    </span>
                                                </td>
                                                <td>
                                                    <?php
                                                    ...
                                                    $start_date = $row['kondisilahan_date'];
                                                    $sla_date = $row['sla_kondisilahan'];
                                                    $status_kondisilahan = $row['status_kondisilahan'];
                                                    ...
                                                    if ($status_kondisilahan === 'Approve') {
                                                ...
                                                <td>
                                                    <!-- Tombol Edit -->
                                                    <?php if ($row['status_kondisilahan'] != "Approve"): ?>
                                                    <?php
                                                    // Mengatur timezone ke Asia/Jakarta (sesuaikan dengan timezone lokal Anda)
                                                    date_default_timezone_set('Asia/Jakarta');
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="legal/kondisi-lahan-process.php" enctype="multipart/form-data">
                                                                    <input type="hidden" name="id" id="modalId" value="<?= $row['id']; ?>">
                                                                    <div class="form-group">
                                                                        <label for="statusSelect">Status Pengondisian Lahan<strong><span style="color: red;">*</span></strong></label>
                                                                        <select class="form-control" id="statusSelect" name="status_kondisilahan">
