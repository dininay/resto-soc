...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($toEmails)) {
        ...
        try {
            ...
            // Email content
            $mail->Subject = 'Notification: 1 New Active ETA Update by IT Resto SOC Ticket';
                            $mail->Body    = '
                                ...
                                <div style="background-color: #f7f7f7; border-radius: 8px; padding: 0; margin: 0; text-align: center;">
                                    ...
                                    <div style="padding: 20px; background-color: #f7f7f7; border-radius: 8px;">
                                        ...
                                        <p>We would like to inform you that a new Active ETA Update by IT Resto SOC Ticket has been created. This needs your attention, please log in to the SOC application to review the details at your earliest convenience.
                            ...
                            $mail->AltBody = 'Dear SCM Team,'
                                        . 'We would like to inform you that a new Active ETA Update by IT Resto SOC Ticket has been created. This needs your attention, please log in to the SOC application to review the details at your earliest convenience.
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        if (isset($kode_lahan) && !empty($kode_lahan)) {
            header("Location: " . $base_url . "/datatables-data-itutensil.php?id=" . urlencode($kode_lahan));
            exit;
        } else {
