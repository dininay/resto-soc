                                    ...
                                    <table class="display table table-striped table-bordered" id="zero_configuration_table" style="width:100%">
                                        ...
                                        <?php foreach ($data as $row): ?>
                                            <tr>
                                                ...
                                                <?php
                                                // Bagian ini di dalam loop yang menampilkan data tabel
                                                $lamp_st_files = explode(",", $row['lamp_st']); // Pisahkan nama file menjadi array
                                                // Periksa apakah array tidak kosong sebelum menampilkan ikon
                                                if (!empty($row['lamp_st'])) {
                                                    echo '<td>
                                                            <ul style="list-style-type: none; padding: 0; margin: 0;">';
                                                    // Loop untuk setiap file dalam array
                                                ...
                                                <?php if ($row['status_fat'] != "Done"): ?>
                                                        <a href="fat/fat-edit-form.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="statusForm" method="post" action="fat/fat-process.php" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="catatan_fat">Catatan TAF</label>
                                                                        <input type="text" class="form-control" id="catatan_fat" name="catatan_fat">
                                                                    </div>
