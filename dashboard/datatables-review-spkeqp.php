		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>List Review SPK Equipment</h1>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="badge rounded-pill badge-<?php echo $badge_color; ?>">
                                                        <?php echo $row['status_eqptaf']; ?>
                                                    </span>
                                                </td>
                                                <td>
                                                    <?php
                                                    // Mendapatkan tanggal sla_date dari kolom data
                                                    $slaLegalDate = new DateTime($row['sla_eqptaf']);
                                                    ...
                                                    if ($today->format('N') == 6 || $today->format('N') == 7) { // N = 6 is Saturday, N = 7 is Sunday
                                                        ...
                                                        // Menghitung scoring
                                                        $scoring = calculateScoring($row['eqptaf_date'], $row['sla_eqptaf'], $sla_value); // Make sure $sla_value is set correctly
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="catatan_eqptaf">Catatan TAF</label>
                                                                        <input type="text" class="form-control" id="catatan_eqptaf" name="catatan_eqptaf">
                                                                    </div>
