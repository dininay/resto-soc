                        ...
                        <div class="card mb-5">
                            ...
                            <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="no_vd">No File VD</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" id="no_vd" name="no_vd" placeholder="Nomor File VD" value="<?php echo $row['no_vd']; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <option value="">Pilih</option>
                                            <option value="TC" <?php echo ($row['tc'] == 'TC') ? 'selected' : ''; ?>>TC</option>
                                            <option value="NO TC" <?php echo ($row['tc'] == 'NO TC') ? 'selected' : ''; ?>>NO TC</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
