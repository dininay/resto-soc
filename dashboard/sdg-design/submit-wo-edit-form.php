...
<body class="text-left">
		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Submit WO Design</h1>
                    <ul>
                        <li><a href="href">Edit</a></li>
                        <li>Submit WO Design</li>
                    </ul>
                </div>
                            ...
                            <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <option>Pilih</option>
                                            <option value="Yes" <?php echo ($row['submit_wo'] == 'Yes') ? 'selected' : ''; ?>>Ya</option>
                                            <option value="No" <?php echo ($row['submit_wo'] == 'No') ? 'selected' : ''; ?>>Tidak</option>
                                        </select>
                                    </div>
                                </div>
    ...
    function toggleObstacleDetail() {
        var obstacleSelect = document.getElementById("submit_wo");
        var lampSurvey = document.getElementById("lamp_wo");
