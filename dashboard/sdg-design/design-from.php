...
$sql_draft = "SELECT DISTINCT kode_lahan FROM negosiator WHERE kode_lahan NOT IN (SELECT DISTINCT kode_lahan FROM sdg_desain)";
    ...
    <script>
        $(document).ready(function() {
            $('#kode_lokasi').change(function() {
                ...
                $.ajax({
                    url: 'design-get.php', // Gunakan file yang sama sebagai URL
                    type: 'post',
		...
		?>
            ...
            <div class="main-content">
                <div class="breadcrumb">
                    <h1>Process Design & Architecture</h1>
                    <ul>
                        <li><a href="href">Form</a></li>
                        <li>Process Design & Architecture</li>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-5">
                            <div class="card-body">
                            <form method="post" action="design-process.php" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="catatan_sdgdesain">Catatan SDG Design</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" id="catatan_sdgdesain" name="catatan_sdgdesain" type="text" placeholder="Catatan Negosiator"/>
                                    </div>
                                </div>
                                <div class="form-group row">
