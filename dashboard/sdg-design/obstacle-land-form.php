...
$sql_draft = "SELECT DISTINCT kode_lahan FROM sdg_desain";
            ...
            <div class="main-content">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-5">
                            <div class="card-body">
                            <form method="post" action="obstacle-land-process.php" enctype="multipart/form-data">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="kode_lokasi">Kode Lahan</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" id="obstacle" name="obstacle" type="text" placeholder="Obstacle"/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="obs_date">Obstacle Date</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" id="obs_date" name="obs_date" type="date" placeholder="Obstacle Date"/>
                                    </div>
                                </div>
                                <!-- <div class="form-group row">
    ...
    <script>
        $(document).ready(function() {
            $('#kode_lokasi').change(function() {
                ...
                $.ajax({
                    url: 'obstacle-land-get.php', // Gunakan file yang sama sebagai URL
                    type: 'post',
