                        ...
                        <div class="card text-left">
                            <div class="card-body">
								...
								<div class="footer-bottom float-right">
									<p><a class="btn btn-primary btn-icon m-1" href="re/bussiness-plan-form.php">+ add Land</a></p>
									<p>
                                            ...
                                            ?>
                                                <td>
                                                    ...
                                                    <span class="badge rounded-pill badge-<?php echo $badge_color; ?>">
                                                        <?php echo $row['status_land']; ?>
                                                    </span>
                                                </td>
                                                
                                                <td>
                                                    <!-- Tombol Edit -->
                                                    <?php if ($row['status_land'] != "Aktif"): ?>
                                                        <button class="btn btn-sm btn-warning edit-btn" data-toggle="modal" data-target="#editModal" data-id="<?= $row['id'] ?>" data-status="<?= $row['status_land'] ?>">
